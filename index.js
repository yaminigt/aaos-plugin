(function(he){"use strict";var Q={exports:{}},M={};/**
 * @license React
...
`.trim(),We=a=>{const s=a.trim();return s===""||s==="—"||s==="-"||s.toLowerCase()==="n/a"},ne=a=>{if(We(a))return[];const s=a.split(",").map(c=>c.trim()).flatMap(c=>c.includes(" / ")&&c.includes("Vehicle.")?c.split(" / ").map(A=>A.trim()):[c]).map(c=>c.trim()).filter(c=>c.length>0&&c!=="—"&&c!=="-"),r=new Set,o=[];for(const c of s)r.has(c)||(r.add(c),o.push(c));return o},Pe=()=>{const a={};for(const s of we.split(`
`)){const r=s.trim();if(!r)continue;const o=r.split("|").map(p=>p.trim()),c=o[0],A=ne(o[1]||""),l=ne(o[2]||"");c&&(a[c]={exact:A,partial:l})}return a};let k=null;const Ue=a=>(k||(k=Pe()),k[a]||{exact:[],partial:[]}),Fe={TIRE_PRESSURE:{serviceId:"0x4100",instanceId:"0x1000",operations:{get:{id:"0x8410",kind:"event",eventGroupId:"0x9410",transport:"reliable",port:"4100",updateCycleMs:3e3}},modes:["get"],notes:"Derived from vsomeip/vsomeip/tire_pressure_sample.json. This config exposes publish/subscribe events, not a writable SOME/IP method for SET."},CURRENT_GEAR:{serviceId:"0x2100",instanceId:"0x8210",modes:["get"]},PERF_VEHICLE_SPEED:{serviceId:"0x2100",instanceId:"0x8211",modes:["get"]}};function ke(a){return Fe[a]||null}const j="http://localhost:3201",je="ws://localhost:3201",ie=[1e3,2e3,4e3,8e3,16e3,3e4],Y="aaos:signal:update",K="aaos:someip:value";let O=null,V=0,H=!1;function m(a){console.info(`[aaosBridge WS] ${a}`)}function re(a){window.dispatchEvent(new CustomEvent(Y,{detail:a})),window.dispatchEvent(new CustomEvent(K,{detail:a}))}function oe(){const a=ie[Math.min(V,ie.length-1)];V++,m(`Reconnecting in ${a}ms (attempt ${V})…`),setTimeout(()=>{H&&ce()},a)}function ce(){if(typeof WebSocket=="undefined")return m("WebSocket not available in this environment."),null;H=!0;try{O=new WebSocket(je)}catch(a){return m(`Failed to construct WebSocket: ${a}`),oe(),null}return O.onopen=()=>{V=0,m("Connected to backend bridge server.")},O.onmessage=a=>{try{const s=JSON.parse(a.data);if(!(s!=null&&s.signalName)){m("Received message missing signalName — skipped.");return}m(`Signal update received: ${s.signalName} = ${s.value}`),re(s)}catch(s){m("Failed to parse incoming WebSocket message.")}},O.onerror=a=>{m(`WebSocket error: ${JSON.stringify(a)}`)},O.onclose=a=>{m(`WebSocket closed (code: ${a.code}, reason: ${a.reason||"none"}).`),O=null,H&&oe()},O}function Ye(){H=!1,O&&(O.close(),O=null)}async function Ke(a){try{const s=await fetch(`${j}/v2/aaos/request`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)});if(!s.ok)return console.error(`[aaosBridge] POST /v2/aaos/request failed: ${s.status} ${s.statusText}`),null;const r=await s.json();return r!=null&&r.signalName&&r.value!==void 0&&re(r),r}catch(s){return console.error("[aaosBridge] sendRequest error:",s),null}}async function qe(a){try{const s=a?`${j}/v2/aaos/latest?signal=${encodeURIComponent(a)}`:`${j}/v2/aaos/latest`,r=await fetch(s);return r.ok?await r.json():(console.error(`[aaosBridge] GET /v2/aaos/latest failed: ${r.status} ${r.statusText}`),null)}catch(s){return console.error("[aaosBridge] getLatestResponse error:",s),null}}const q={sendRequest:Ke,getLatestResponse:qe,connectWebSocket:ce,disconnectWebSocket:Ye},ze=globalThis.React,{useEffect:z,useState:g}=ze,f=(...a)=>a.filter(Boolean).join(" "),$e=a=>{switch(a){case"STRING":return"string";case"BOOLEAN":return"boolean";case"INT32":return"int32";case"INT32_VEC":return"int32[]";case"INT64":return"int64";case"INT64_VEC":return"int64[]";case"FLOAT":return"float";case"FLOAT_VEC":return"float[]";case"BYTES":return"uint8[]";case"MIXED":default:return"string"}},Xe=a=>a.access.includes("READ_WRITE")||a.access.includes("WRITE")?"actuator":"sensor",Ze=a=>`Aaos.${a.area}.${a.name}`,w=({text:a,ariaLabel:s})=>{const[r,o]=g(!1);z(()=>{if(!r)return;const A=setTimeout(()=>o(!1),1500);return()=>clearTimeout(A)},[r]);const c=async()=>{var A;try{if((A=navigator==null?void 0:navigator.clipboard)!=null&&A.writeText)await navigator.clipboard.writeText(a);else{const l=document.createElement("textarea");l.value=a,document.body.appendChild(l),l.select(),document.execCommand("copy"),document.body.removeChild(l)}o(!0)}catch(l){}};return t.jsx("button",{type:"button",className:f("aaos-copy-btn",r&&"is-done"),onClick:c,"aria-label":s||"Copy",title:r?"Copied!":"Copy",children:r?t.jsx(Me,{}):t.jsx(Ge,{})})},de="aaos:someip:request";q.connectWebSocket();const Qe=a=>{const s=a.includes("READ")||a.includes("READ_WRITE"),r=a.includes("WRITE")||a.includes("READ_WRITE"),o=[];return s&&o.push("get"),r&&o.push("set"),o},Je=({signal:a,api:s,modelId:r})=>{var Ie;const[o,c]=g({kind:"idle"}),[A,l]=g("get"),[p,b]=g(""),[S,L]=g(""),[$,d]=g(void 0),[E,_]=g(""),[N,v]=g(""),[le,y]=g(!1),R=o,X=A,Ae=$,i=ke(a.name),u=Qe(a.access);(Ie=i==null?void 0:i.operations)==null||Ie[X],z(()=>{var I,h;c({kind:"idle"}),l("get"),b((I=i==null?void 0:i.serviceId)!=null?I:""),L((h=i==null?void 0:i.instanceId)!=null?h:""),d(void 0),_(""),v("");const n=u.includes("get")?"get":u.includes("set")?"set":"get";l(n),y(!1)},[a.name]),z(()=>{const n=I=>{const h=I,T=h==null?void 0:h.detail;!(T!=null&&T.signalName)||T.signalName!==a.name||(d(T.value===void 0?null:T.value),v(T.timestamp||new Date().toISOString()),y(!1))};return window.addEventListener(Y,n),window.addEventListener(K,n),()=>{window.removeEventListener(Y,n),window.removeEventListener(K,n)}},[a.name]);const pe=De(a),Te=ve(a),W=Ze(a),P=Ue(a.name),x=typeof(s==null?void 0:s.createWishlistApi)=="function"&&!!r,ia=async()=>{var h,T,G;if(!u.includes("get"))return;const n=(h=i==null?void 0:i.operations)==null?void 0:h.get,I={signalName:a.name,mode:"get",someip:{serviceId:p||(i==null?void 0:i.serviceId)||"",instanceId:S||(i==null?void 0:i.instanceId)||"",operationId:n==null?void 0:n.id,operationKind:n==null?void 0:n.kind,eventGroupId:n==null?void 0:n.eventGroupId,transport:n==null?void 0:n.transport,port:n==null?void 0:n.port,updateCycleMs:n==null?void 0:n.updateCycleMs,operations:{get:(T=i==null?void 0:i.operations)!=null&&T.get?{id:i.operations.get.id,kind:i.operations.get.kind,eventGroupId:i.operations.get.eventGroupId,transport:i.operations.get.transport,port:i.operations.get.port,updateCycleMs:i.operations.get.updateCycleMs}:void 0,set:(G=i==null?void 0:i.operations)!=null&&G.set?{id:i.operations.set.id,kind:i.operations.set.kind,eventGroupId:i.operations.set.eventGroupId,transport:i.operations.set.transport,port:i.operations.set.port,updateCycleMs:i.operations.set.updateCycleMs}:void 0}},requestedAt:new Date().toISOString()};l("get"),y(!0);try{await q.sendRequest(I)}catch(C){y(!1);const Z=(C==null?void 0:C.message)||"Failed to send SOME/IP GET request package.";c({kind:"error",message:Z})}window.dispatchEvent(new CustomEvent(de,{detail:I}))},ra=async()=>{var h,T,G;if(!u.includes("set"))return;const n=(h=i==null?void 0:i.operations)==null?void 0:h.set,I={signalName:a.name,mode:"set",value:E,someip:{serviceId:p||(i==null?void 0:i.serviceId)||"",instanceId:S||(i==null?void 0:i.instanceId)||"",operationId:n==null?void 0:n.id,operationKind:n==null?void 0:n.kind,eventGroupId:n==null?void 0:n.eventGroupId,transport:n==null?void 0:n.transport,port:n==null?void 0:n.port,updateCycleMs:n==null?void 0:n.updateCycleMs,operations:{get:(T=i==null?void 0:i.operations)!=null&&T.get?{id:i.operations.get.id,kind:i.operations.get.kind,eventGroupId:i.operations.get.eventGroupId,transport:i.operations.get.transport,port:i.operations.get.port,updateCycleMs:i.operations.get.updateCycleMs}:void 0,set:(G=i==null?void 0:i.operations)!=null&&G.set?{id:i.operations.set.id,kind:i.operations.set.kind,eventGroupId:i.operations.set.eventGroupId,transport:i.operations.set.transport,port:i.operations.set.port,updateCycleMs:i.operations.set.updateCycleMs}:void 0}},requestedAt:new Date().toISOString()};l("set"),y(!0);try{await q.sendRequest(I)}catch(C){y(!1);const Z=(C==null?void 0:C.message)||"Failed to send SOME/IP SET request package.";c({kind:"error",message:Z})}window.dispatchEvent(new CustomEvent(de,{detail:I}))},oa=async()=>{if(x)try{c({kind:"loading"}),await s.createWishlistApi({model:r,apiName:W,description:a.description,type:Xe(a),datatype:$e(a.dataType),skeleton:W,isWishlist:!0,...a.unit?{unit:a.unit}:{}}),c({kind:"success",message:`Added "${W}" as a wishlist signal.`})}catch(n){const I=(n==null?void 0:n.message)||"Failed to add as wishlist signal. See host toast.";c({kind:"error",message:I})}},U=[{key:"Signal",value:a.name},{key:"Group (Name)",value:a.group},{key:"Full Path",value:Te},{key:"Property ID",value:pe},{key:"Description",value:a.description},{key:"Change Mode",value:a.changeMode},{key:"Access",value:a.access.join(", ")},{key:"Vehicle Area",value:a.area},{key:"Data Type",value:a.dataType},{key:"VHAL Version",value:String(a.version)}];return a.unit&&U.push({key:"Unit",value:a.unit}),a.dataEnum&&a.dataEnum.length>0&&U.push({key:"Data Enum",value:a.dataEnum.join(", ")}),a.dataEnumBitFlags&&U.push({key:"Bit Flags",value:"data_enum_bit_flags"}),t.jsxs("div",{className:"aaos-detail",children:[t.jsxs("div",{className:"aaos-detail-bar",children:[t.jsxs("div",{className:"aaos-detail-name",children:[t.jsx("span",{children:a.name}),t.jsx(w,{text:a.name,ariaLabel:"Copy signal name"})]}),t.jsx("div",{className:"aaos-area-pill",children:a.area})]}),t.jsxs("div",{className:"aaos-detail-body",children:[t.jsx("div",{className:"aaos-section-title",children:"AAOS VehicleProperty"}),t.jsx("table",{className:"aaos-prop-table",children:t.jsx("tbody",{children:U.map(n=>t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:n.key}),t.jsx("td",{className:"v",children:n.value})]},n.key))})}),t.jsx("div",{className:"aaos-section-title has-spacing",children:"COVESA matching signals"}),t.jsx("table",{className:"aaos-prop-table",children:t.jsxs("tbody",{children:[t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Exact matches"}),t.jsx("td",{className:"v",children:P.exact.length===0?t.jsx("span",{children:"—"}):t.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:P.exact.map(n=>t.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[t.jsx("span",{children:n}),t.jsx(w,{text:n,ariaLabel:"Copy exact COVESA match"})]},`exact-${n}`))})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Partial matches"}),t.jsx("td",{className:"v",children:P.partial.length===0?t.jsx("span",{children:"—"}):t.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:P.partial.map(n=>t.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[t.jsx("span",{children:n}),t.jsx(w,{text:n,ariaLabel:"Copy partial COVESA match"})]},`partial-${n}`))})})]})]})}),t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"aaos-section-title has-spacing",children:"SOME/IP Mapping"}),t.jsx("table",{className:"aaos-prop-table",children:t.jsxs("tbody",{children:[t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Service ID"}),t.jsx("td",{className:"v",children:t.jsx("input",{className:"aaos-edit-field",value:p,onChange:n=>b(n.target.value),placeholder:"Enter Service ID",spellCheck:!1})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Instance ID"}),t.jsx("td",{className:"v",children:t.jsx("input",{className:"aaos-edit-field",value:S,onChange:n=>L(n.target.value),placeholder:"Enter Instance ID",spellCheck:!1})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Value"}),t.jsx("td",{className:"v",children:Ae===void 0?t.jsx("span",{className:"aaos-value-placeholder",children:le?"Waiting for value from image...":"Press Get to request value"}):t.jsx("span",{className:"aaos-value-chip",children:String(Ae)})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Set Value"}),t.jsx("td",{className:"v",children:t.jsx("input",{className:"aaos-edit-field",value:E,onChange:n=>_(n.target.value),placeholder:"Enter value to set",spellCheck:!1})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Last Response Time"}),t.jsx("td",{className:"v",children:N?t.jsx("span",{className:"aaos-value-meta",children:N}):t.jsx("span",{className:"aaos-value-placeholder",children:"No response yet"})})]})]})}),t.jsxs("div",{className:"aaos-someip-actions",style:{marginTop:10},children:[t.jsx("button",{type:"button",disabled:!u.includes("get"),className:f("aaos-segment-btn",X==="get"&&u.includes("get")&&"is-active",!u.includes("get")&&"is-disabled"),onClick:ia,children:le?"Getting...":"Get"}),t.jsx("button",{type:"button",disabled:!u.includes("set"),className:f("aaos-segment-btn",X==="set"&&u.includes("set")&&"is-active",!u.includes("set")&&"is-disabled"),onClick:ra,children:"Set"})]})]}),t.jsx("div",{className:"aaos-section-title has-spacing",children:"Property ID Composition"}),t.jsx("table",{className:"aaos-prop-table",children:t.jsxs("tbody",{children:[t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Base ID"}),t.jsx("td",{className:"v",children:a.baseId})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Group"}),t.jsx("td",{className:"v",children:"SYSTEM (0x10000000)"})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Vehicle Area"}),t.jsx("td",{className:"v",children:a.area})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Data Type"}),t.jsx("td",{className:"v",children:a.dataType})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Computed ID"}),t.jsx("td",{className:"v",children:pe})]})]})}),t.jsxs("div",{className:"aaos-actions",children:[t.jsxs("button",{type:"button",className:f("aaos-btn",!x&&"is-secondary"),onClick:oa,disabled:!x||R.kind==="loading",title:x?`Register ${W} as a wishlist signal on this model`:"Wishlist API is unavailable in this context",children:[t.jsx(Be,{}),R.kind==="loading"?"Adding…":"Add as wishlist signal"]}),t.jsx(w,{text:Te,ariaLabel:"Copy full path"})]}),t.jsxs("div",{className:f("aaos-status",R.kind==="error"&&"is-error",R.kind==="success"&&"is-success",R.kind!=="error"&&R.kind!=="success"&&"is-info"),children:[R.kind==="success"&&R.message,R.kind==="error"&&R.message,R.kind==="idle"&&!x&&t.jsx("span",{children:s!=null&&s.createWishlistApi?"No model in context — wishlist signals require a model.":"Wishlist API not provided by host."})]})]})]})},ea=globalThis.React,{useState:aa}=ea,ta=({data:a,api:s})=>{var l;const[r,o]=aa(null),c=new Set(F.map(p=>p.group)).size,A=(l=a==null?void 0:a.model)==null?void 0:l.id;return t.jsxs("div",{className:"aaos-root",children:[t.jsxs("div",{className:"aaos-header",children:[t.jsxs("div",{className:"aaos-header-title",children:[t.jsx(ee,{}),t.jsx("span",{children:"AAOS Vehicle Properties"})]}),t.jsx("div",{className:"aaos-header-right",children:t.jsxs("div",{className:"aaos-header-counter",children:[F.length," signals · ",c," groups"]})})]}),t.jsxs("div",{className:"aaos-body",children:[t.jsx(He,{signals:F,selectedSignal:r,onSelectSignal:o}),t.jsx("div",{className:"aaos-right",children:r?t.jsx(Je,{signal:r,api:s,modelId:A}):t.jsxs("div",{className:"aaos-placeholder",children:[t.jsx("div",{className:"aaos-placeholder-icon",children:t.jsx(ee,{size:56})}),t.jsx("div",{className:"aaos-placeholder-title",children:"Select an AAOS signal to view its details"}),t.jsx("div",{className:"aaos-placeholder-sub",children:"Pick a signal from the list on the left"})]})})]})]})},Ee="aaos-plugin-styles",sa=`
.aaos-root {
  --aaos-bg: #ffffff;
  --aaos-fg: #0f172a;
  --aaos-muted: #64748b;
...
`,na=()=>{if(typeof document=="undefined"||document.getElementById(Ee))return;const a=document.createElement("style");a.id=Ee,a.appendChild(document.createTextNode(sa)),document.head.appendChild(a)};window.DAPlugins||(window.DAPlugins={}),window.DAPlugins["page-plugin"]={components:{Page:ta},unmount:a=>{a&&(a.innerHTML="")}},na()})(React);
