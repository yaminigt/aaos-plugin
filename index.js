(function(k){"use strict";var G={exports:{}},S={};/**
 * @license React
...
`.trim(),le=s=>{const t=s.trim();return t===""||t==="—"||t==="-"||t.toLowerCase()==="n/a"},w=s=>{if(le(s))return[];const t=s.split(",").map(o=>o.trim()).flatMap(o=>o.includes(" / ")&&o.includes("Vehicle.")?o.split(" / ").map(A=>A.trim()):[o]).map(o=>o.trim()).filter(o=>o.length>0&&o!=="—"&&o!=="-"),i=new Set,n=[];for(const o of t)i.has(o)||(i.add(o),n.push(o));return n},Te=()=>{const s={};for(const t of Ae.split(`
`)){const i=t.trim();if(!i)continue;const n=i.split("|").map(T=>T.trim()),o=n[0],A=w(n[1]||""),E=w(n[2]||"");o&&(s[o]={exact:A,partial:E})}return s};let x=null;const pe=s=>(x||(x=Te()),x[s]||{exact:[],partial:[]}),Ie={TIRE_PRESSURE:{serviceId:"0x4100",instanceId:"0x1000",operations:{get:{id:"0x8410",kind:"event",eventGroupId:"0x9410",transport:"reliable",port:"4100",updateCycleMs:3e3}},modes:["get"],notes:"Derived from vsomeip/vsomeip/tire_pressure_sample.json. This config exposes publish/subscribe events, not a writable SOME/IP method for SET."},CURRENT_GEAR:{serviceId:"0x2100",instanceId:"0x8210",modes:["get"]},PERF_VEHICLE_SPEED:{serviceId:"0x2100",instanceId:"0x8211",modes:["get"]}};function he(s){return Ie[s]||null}const _e=globalThis.React,{useEffect:P,useState:O}=_e,m=(...s)=>s.filter(Boolean).join(" "),Ne=s=>{switch(s){case"STRING":return"string";case"BOOLEAN":return"boolean";case"INT32":return"int32";case"INT32_VEC":return"int32[]";case"INT64":return"int64";case"INT64_VEC":return"int64[]";case"FLOAT":return"float";case"FLOAT_VEC":return"float[]";case"BYTES":return"uint8[]";case"MIXED":default:return"string"}},Re=s=>s.access.includes("READ_WRITE")||s.access.includes("WRITE")?"actuator":"sensor",Oe=s=>`Aaos.${s.area}.${s.name}`,D=({text:s,ariaLabel:t})=>{const[i,n]=O(!1);P(()=>{if(!i)return;const A=setTimeout(()=>n(!1),1500);return()=>clearTimeout(A)},[i]);const o=async()=>{var A;try{if((A=navigator==null?void 0:navigator.clipboard)!=null&&A.writeText)await navigator.clipboard.writeText(s);else{const E=document.createElement("textarea");E.value=s,document.body.appendChild(E),E.select(),document.execCommand("copy"),document.body.removeChild(E)}n(!0)}catch(E){}};return a.jsx("button",{type:"button",className:m("aaos-copy-btn",i&&"is-done"),onClick:o,"aria-label":t||"Copy",title:i?"Copied!":"Copy",children:i?a.jsx(oe,{}):a.jsx(re,{})})},me=({signal:s,api:t,modelId:i})=>{var F;const[n,o]=O({kind:"idle"}),[A,E]=O("get"),[T,u]=O(""),[g,N]=O(""),l=n,c=A,r=he(s.name);P(()=>{var d,y;o({kind:"idle"}),E("get"),u((d=r==null?void 0:r.serviceId)!=null?d:""),N((y=r==null?void 0:r.instanceId)!=null?y:"")},[s.name]);const p=ee(s),I=ae(s),h=Oe(s),v=pe(s.name),_=(F=r==null?void 0:r.operations)==null?void 0:F[c],L=typeof(t==null?void 0:t.createWishlistApi)=="function"&&!!i,De=async()=>{if(L)try{o({kind:"loading"}),await t.createWishlistApi({model:i,apiName:h,description:s.description,type:Re(s),datatype:Ne(s.dataType),skeleton:h,isWishlist:!0,...s.unit?{unit:s.unit}:{}}),o({kind:"success",message:`Added "${h}" as a wishlist signal.`})}catch(d){const y=(d==null?void 0:d.message)||"Failed to add as wishlist signal. See host toast.";o({kind:"error",message:y})}},b=[{key:"Signal",value:s.name},{key:"Group (Name)",value:s.group},{key:"Full Path",value:I},{key:"Property ID",value:p},{key:"Description",value:s.description},{key:"Change Mode",value:s.changeMode},{key:"Access",value:s.access.join(", ")},{key:"Vehicle Area",value:s.area},{key:"Data Type",value:s.dataType},{key:"VHAL Version",value:String(s.version)}];return s.unit&&b.push({key:"Unit",value:s.unit}),s.dataEnum&&s.dataEnum.length>0&&b.push({key:"Data Enum",value:s.dataEnum.join(", ")}),s.dataEnumBitFlags&&b.push({key:"Bit Flags",value:"data_enum_bit_flags"}),a.jsxs("div",{className:"aaos-detail",children:[a.jsxs("div",{className:"aaos-detail-bar",children:[a.jsxs("div",{className:"aaos-detail-name",children:[a.jsx("span",{children:s.name}),a.jsx(D,{text:s.name,ariaLabel:"Copy signal name"})]}),a.jsx("div",{className:"aaos-area-pill",children:s.area})]}),a.jsxs("div",{className:"aaos-detail-body",children:[a.jsx("div",{className:"aaos-section-title",children:"AAOS VehicleProperty"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsx("tbody",{children:b.map(d=>a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:d.key}),a.jsx("td",{className:"v",children:d.value})]},d.key))})}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"COVESA matching signals"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Exact matches"}),a.jsx("td",{className:"v",children:v.exact.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:v.exact.map(d=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:d}),a.jsx(D,{text:d,ariaLabel:"Copy exact COVESA match"})]},`exact-${d}`))})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Partial matches"}),a.jsx("td",{className:"v",children:v.partial.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:v.partial.map(d=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:d}),a.jsx(D,{text:d,ariaLabel:"Copy partial COVESA match"})]},`partial-${d}`))})})]})]})}),r&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"aaos-section-title has-spacing",children:"SOME/IP Mapping"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Service ID"}),a.jsx("td",{className:"v",children:a.jsx("input",{className:"aaos-edit-field",value:T,onChange:d=>u(d.target.value),spellCheck:!1})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Instance ID"}),a.jsx("td",{className:"v",children:a.jsx("input",{className:"aaos-edit-field",value:g,onChange:d=>N(d.target.value),spellCheck:!1})})]}),_&&a.jsxs("tr",{children:[a.jsxs("td",{className:"k",children:[_.kind.charAt(0).toUpperCase()+_.kind.slice(1)," ","ID"]}),a.jsx("td",{className:"v",children:_.id})]}),(_==null?void 0:_.eventGroupId)&&a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Event Group ID"}),a.jsx("td",{className:"v",children:_.eventGroupId})]})]})}),a.jsxs("div",{className:"aaos-someip-actions",style:{marginTop:10},children:[a.jsx("button",{type:"button",disabled:!r.modes.includes("get"),className:m("aaos-segment-btn",c==="get"&&r.modes.includes("get")&&"is-active",!r.modes.includes("get")&&"is-disabled"),onClick:()=>r.modes.includes("get")&&E("get"),children:"Get"}),a.jsx("button",{type:"button",disabled:!r.modes.includes("set"),className:m("aaos-segment-btn",c==="set"&&r.modes.includes("set")&&"is-active",!r.modes.includes("set")&&"is-disabled"),onClick:()=>r.modes.includes("set")&&E("set"),children:"Set"})]})]}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"Property ID Composition"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Base ID"}),a.jsx("td",{className:"v",children:s.baseId})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Group"}),a.jsx("td",{className:"v",children:"SYSTEM (0x10000000)"})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Vehicle Area"}),a.jsx("td",{className:"v",children:s.area})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Data Type"}),a.jsx("td",{className:"v",children:s.dataType})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Computed ID"}),a.jsx("td",{className:"v",children:p})]})]})}),a.jsxs("div",{className:"aaos-actions",children:[a.jsxs("button",{type:"button",className:m("aaos-btn",!L&&"is-secondary"),onClick:De,disabled:!L||l.kind==="loading",title:L?`Register ${h} as a wishlist signal on this model`:"Wishlist API is unavailable in this context",children:[a.jsx(ce,{}),l.kind==="loading"?"Adding…":"Add as wishlist signal"]}),a.jsx(D,{text:I,ariaLabel:"Copy full path"})]}),a.jsxs("div",{className:m("aaos-status",l.kind==="error"&&"is-error",l.kind==="success"&&"is-success",l.kind!=="error"&&l.kind!=="success"&&"is-info"),children:[l.kind==="success"&&l.message,l.kind==="error"&&l.message,l.kind==="idle"&&!L&&a.jsx("span",{children:t!=null&&t.createWishlistApi?"No model in context — wishlist signals require a model.":"Wishlist API not provided by host."})]})]})]})},ue=globalThis.React,{useState:ge}=ue,Le=({data:s,api:t})=>{var E;const[i,n]=ge(null),o=new Set(f.map(T=>T.group)).size,A=(E=s==null?void 0:s.model)==null?void 0:E.id;return a.jsxs("div",{className:"aaos-root",children:[a.jsxs("div",{className:"aaos-header",children:[a.jsxs("div",{className:"aaos-header-title",children:[a.jsx(B,{}),a.jsx("span",{children:"AAOS Vehicle Properties"})]}),a.jsx("div",{className:"aaos-header-right",children:a.jsxs("div",{className:"aaos-header-counter",children:[f.length," signals · ",o," groups"]})})]}),a.jsxs("div",{className:"aaos-body",children:[a.jsx(Ee,{signals:f,selectedSignal:i,onSelectSignal:n}),a.jsx("div",{className:"aaos-right",children:i?a.jsx(me,{signal:i,api:t,modelId:A}):a.jsxs("div",{className:"aaos-placeholder",children:[a.jsx("div",{className:"aaos-placeholder-icon",children:a.jsx(B,{size:56})}),a.jsx("div",{className:"aaos-placeholder-title",children:"Select an AAOS signal to view its details"}),a.jsx("div",{className:"aaos-placeholder-sub",children:"Pick a signal from the list on the left"})]})})]})]})},U="aaos-plugin-styles",Se=`
.aaos-root {
  --aaos-bg: #ffffff;
  --aaos-fg: #0f172a;
  --aaos-muted: #64748b;
...
`,Ce=()=>{if(typeof document=="undefined"||document.getElementById(U))return;const s=document.createElement("style");s.id=U,s.appendChild(document.createTextNode(Se)),document.head.appendChild(s)};window.DAPlugins||(window.DAPlugins={}),window.DAPlugins["page-plugin"]={components:{Page:Le},unmount:s=>{s&&(s.innerHTML="")}},Ce()})(React);
