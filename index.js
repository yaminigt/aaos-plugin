...
`.trim(),Pe=a=>{const s=a.trim();return s===""||s==="—"||s==="-"||s.toLowerCase()==="n/a"},re=a=>{if(Pe(a))return[];const s=a.split(",").map(c=>c.trim()).flatMap(c=>c.includes(" / ")&&c.includes("Vehicle.")?c.split(" / ").map(A=>A.trim()):[c]).map(c=>c.trim()).filter(c=>c.length>0&&c!=="—"&&c!=="-"),r=new Set,o=[];for(const c of s)r.has(c)||(r.add(c),o.push(c));return o},Ue=()=>{const a={};for(const s of We.split(`
`)){const r=s.trim();if(!r)continue;const o=r.split("|").map(T=>T.trim()),c=o[0],A=re(o[1]||""),l=re(o[2]||"");c&&(a[c]={exact:A,partial:l})}return a};let q=null;const Fe=a=>(q||(q=Ue()),q[a]||{exact:[],partial:[]}),ke={TIRE_PRESSURE:{serviceId:"0x4100",instanceId:"0x1000",operations:{get:{id:"0x8410",kind:"event",eventGroupId:"0x9410",transport:"reliable",port:"4100",updateCycleMs:3e3}},modes:["get"],notes:"Derived from vsomeip/vsomeip/tire_pressure_sample.json. This config exposes publish/subscribe events, not a writable SOME/IP method for SET."},CURRENT_GEAR:{serviceId:"0x2100",instanceId:"0x8210",modes:["get"]},PERF_VEHICLE_SPEED:{serviceId:"0x2100",instanceId:"0x8211",modes:["get"]}};function je(a){return ke[a]||null}const z="http://localhost:3201",Ye="ws://localhost:3201",oe=[1e3,2e3,4e3,8e3,16e3,3e4],$="aaos:signal:update",X="aaos:someip:value";let O=null,W=0,P=!1;function m(a){console.info(`[aaosBridge WS] ${a}`)}function ce(a){window.dispatchEvent(new CustomEvent($,{detail:a})),window.dispatchEvent(new CustomEvent(X,{detail:a}))}function de(){const a=oe[Math.min(W,oe.length-1)];W++,m(`Reconnecting in ${a}ms (attempt ${W})…`),setTimeout(()=>{P&&Ee()},a)}function Ee(){if(typeof WebSocket=="undefined")return m("WebSocket not available in this environment."),null;P=!0;try{O=new WebSocket(Ye)}catch(a){return m(`Failed to construct WebSocket: ${a}`),de(),null}return O.onopen=()=>{W=0,m("Connected to backend bridge server.")},O.onmessage=a=>{try{const s=JSON.parse(a.data);if(!(s!=null&&s.signalName)){m("Received message missing signalName — skipped.");return}m(`Signal update received: ${s.signalName} = ${s.value}`),ce(s)}catch(s){m("Failed to parse incoming WebSocket message.")}},O.onerror=a=>{m(`WebSocket error: ${JSON.stringify(a)}`)},O.onclose=a=>{m(`WebSocket closed (code: ${a.code}, reason: ${a.reason||"none"}).`),O=null,P&&de()},O}function Ke(){P=!1,O&&(O.close(),O=null)}async function qe(a){try{const s=await fetch(`${z}/v2/aaos/request`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)});if(!s.ok)return console.error(`[aaosBridge] POST /v2/aaos/request failed: ${s.status} ${s.statusText}`),null;const r=await s.json();return r!=null&&r.signalName&&r.value!==void 0&&ce(r),r}catch(s){return console.error("[aaosBridge] sendRequest error:",s),null}}async function ze(a){try{const s=a?`${z}/v2/aaos/latest?signal=${encodeURIComponent(a)}`:`${z}/v2/aaos/latest`,r=await fetch(s);return r.ok?await r.json():(console.error(`[aaosBridge] GET /v2/aaos/latest failed: ${r.status} ${r.statusText}`),null)}catch(s){return console.error("[aaosBridge] getLatestResponse error:",s),null}}const Z={sendRequest:qe,getLatestResponse:ze,connectWebSocket:Ee,disconnectWebSocket:Ke},$e=globalThis.React,{useEffect:Q,useState:g}=$e,b=(...a)=>a.filter(Boolean).join(" "),Xe=a=>{switch(a){case"STRING":return"string";case"BOOLEAN":return"boolean";case"INT32":return"int32";case"INT32_VEC":return"int32[]";case"INT64":return"int64";case"INT64_VEC":return"int64[]";case"FLOAT":return"float";case"FLOAT_VEC":return"float[]";case"BYTES":return"uint8[]";case"MIXED":default:return"string"}},Ze=a=>a.access.includes("READ_WRITE")||a.access.includes("WRITE")?"actuator":"sensor",Qe=a=>`Aaos.${a.area}.${a.name}`,U=({text:a,ariaLabel:s})=>{const[r,o]=g(!1);Q(()=>{if(!r)return;const A=setTimeout(()=>o(!1),1500);return()=>clearTimeout(A)},[r]);const c=async()=>{var A;try{if((A=navigator==null?void 0:navigator.clipboard)!=null&&A.writeText)await navigator.clipboard.writeText(a);else{const l=document.createElement("textarea");l.value=a,document.body.appendChild(l),l.select(),document.execCommand("copy"),document.body.removeChild(l)}o(!0)}catch(l){}};return t.jsx("button",{type:"button",className:b("aaos-copy-btn",r&&"is-done"),onClick:c,"aria-label":s||"Copy",title:r?"Copied!":"Copy",children:r?t.jsx(Be,{}):t.jsx(Me,{})})},le="aaos:someip:request";Z.connectWebSocket();const Je=a=>{const s=a.includes("READ")||a.includes("READ_WRITE"),r=a.includes("WRITE")||a.includes("READ_WRITE"),o=[];return s&&o.push("get"),r&&o.push("set"),o},ea=({signal:a,api:s,modelId:r})=>{var he;const[o,c]=g({kind:"idle"}),[A,l]=g("get"),[T,x]=g(""),[L,C]=g(""),[G,d]=g(""),[E,I]=g(""),[N,v]=g(""),[pe,y]=g(!1),R=o,J=A,n=je(a.name),M=Je(a.access),B=M.includes("get"),F=M.includes("set"),ra=F;(he=n==null?void 0:n.operations)==null||he[J],Q(()=>{var h,_,p,S,u,f;c({kind:"idle"}),l("get"),x((h=n==null?void 0:n.serviceId)!=null?h:""),C((_=n==null?void 0:n.instanceId)!=null?_:""),d(((S=(p=n==null?void 0:n.operations)==null?void 0:p.get)==null?void 0:S.id)||((f=(u=n==null?void 0:n.operations)==null?void 0:u.set)==null?void 0:f.id)||""),I(""),v("");const i=M.includes("get")?"get":M.includes("set")?"set":"get";l(i),y(!1)},[a.name]),Q(()=>{const i=h=>{const _=h,p=_==null?void 0:_.detail;!(p!=null&&p.signalName)||p.signalName!==a.name||(I(p.value===void 0?"":String(p.value)),v(p.timestamp||new Date().toISOString()),y(!1))};return window.addEventListener($,i),window.addEventListener(X,i),()=>{window.removeEventListener($,i),window.removeEventListener(X,i)}},[a.name]);const Te=ve(a),Ie=ye(a),k=Qe(a),j=Fe(a.name),V=typeof(s==null?void 0:s.createWishlistApi)=="function"&&!!r,oa=async()=>{var _,p,S;if(!B)return;const i=(_=n==null?void 0:n.operations)==null?void 0:_.get,h={signalName:a.name,mode:"get",someip:{serviceId:T||(n==null?void 0:n.serviceId)||"",instanceId:L||(n==null?void 0:n.instanceId)||"",operationId:G||(i==null?void 0:i.id),operationKind:i==null?void 0:i.kind,eventGroupId:i==null?void 0:i.eventGroupId,transport:i==null?void 0:i.transport,port:i==null?void 0:i.port,updateCycleMs:i==null?void 0:i.updateCycleMs,operations:{get:(p=n==null?void 0:n.operations)!=null&&p.get?{id:n.operations.get.id,kind:n.operations.get.kind,eventGroupId:n.operations.get.eventGroupId,transport:n.operations.get.transport,port:n.operations.get.port,updateCycleMs:n.operations.get.updateCycleMs}:void 0,set:(S=n==null?void 0:n.operations)!=null&&S.set?{id:n.operations.set.id,kind:n.operations.set.kind,eventGroupId:n.operations.set.eventGroupId,transport:n.operations.set.transport,port:n.operations.set.port,updateCycleMs:n.operations.set.updateCycleMs}:void 0}},requestedAt:new Date().toISOString()};l("get"),y(!0);try{await Z.sendRequest(h)}catch(u){y(!1);const f=(u==null?void 0:u.message)||"Failed to send SOME/IP GET request package.";c({kind:"error",message:f})}window.dispatchEvent(new CustomEvent(le,{detail:h}))},ca=async()=>{var _,p,S;if(!M.includes("set"))return;const i=(_=n==null?void 0:n.operations)==null?void 0:_.set,h={signalName:a.name,mode:"set",value:E,someip:{serviceId:T||(n==null?void 0:n.serviceId)||"",instanceId:L||(n==null?void 0:n.instanceId)||"",operationId:G||(i==null?void 0:i.id),operationKind:i==null?void 0:i.kind,eventGroupId:i==null?void 0:i.eventGroupId,transport:i==null?void 0:i.transport,port:i==null?void 0:i.port,updateCycleMs:i==null?void 0:i.updateCycleMs,operations:{get:(p=n==null?void 0:n.operations)!=null&&p.get?{id:n.operations.get.id,kind:n.operations.get.kind,eventGroupId:n.operations.get.eventGroupId,transport:n.operations.get.transport,port:n.operations.get.port,updateCycleMs:n.operations.get.updateCycleMs}:void 0,set:(S=n==null?void 0:n.operations)!=null&&S.set?{id:n.operations.set.id,kind:n.operations.set.kind,eventGroupId:n.operations.set.eventGroupId,transport:n.operations.set.transport,port:n.operations.set.port,updateCycleMs:n.operations.set.updateCycleMs}:void 0}},requestedAt:new Date().toISOString()};l("set"),y(!0);try{await Z.sendRequest(h)}catch(u){y(!1);const f=(u==null?void 0:u.message)||"Failed to send SOME/IP SET request package.";c({kind:"error",message:f})}window.dispatchEvent(new CustomEvent(le,{detail:h}))},da=async()=>{if(V)try{c({kind:"loading"}),await s.createWishlistApi({model:r,apiName:k,description:a.description,type:Ze(a),datatype:Xe(a.dataType),skeleton:k,isWishlist:!0,...a.unit?{unit:a.unit}:{}}),c({kind:"success",message:`Added "${k}" as a wishlist signal.`})}catch(i){const h=(i==null?void 0:i.message)||"Failed to add as wishlist signal. See host toast.";c({kind:"error",message:h})}},Y=[{key:"Signal",value:a.name},{key:"Group (Name)",value:a.group},{key:"Full Path",value:Ie},{key:"Property ID",value:Te},{key:"Description",value:a.description},{key:"Change Mode",value:a.changeMode},{key:"Access",value:a.access.join(", ")},{key:"Vehicle Area",value:a.area},{key:"Data Type",value:a.dataType},{key:"VHAL Version",value:String(a.version)}];return a.unit&&Y.push({key:"Unit",value:a.unit}),a.dataEnum&&a.dataEnum.length>0&&Y.push({key:"Data Enum",value:a.dataEnum.join(", ")}),a.dataEnumBitFlags&&Y.push({key:"Bit Flags",value:"data_enum_bit_flags"}),t.jsxs("div",{className:"aaos-detail",children:[t.jsxs("div",{className:"aaos-detail-bar",children:[t.jsxs("div",{className:"aaos-detail-name",children:[t.jsx("span",{children:a.name}),t.jsx(U,{text:a.name,ariaLabel:"Copy signal name"})]}),t.jsx("div",{className:"aaos-area-pill",children:a.area})]}),t.jsxs("div",{className:"aaos-detail-body",children:[t.jsx("div",{className:"aaos-section-title",children:"AAOS VehicleProperty"}),t.jsx("table",{className:"aaos-prop-table",children:t.jsx("tbody",{children:Y.map(i=>t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:i.key}),t.jsx("td",{className:"v",children:i.value})]},i.key))})}),t.jsx("div",{className:"aaos-section-title has-spacing",children:"COVESA matching signals"}),t.jsx("table",{className:"aaos-prop-table",children:t.jsxs("tbody",{children:[t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Exact matches"}),t.jsx("td",{className:"v",children:j.exact.length===0?t.jsx("span",{children:"—"}):t.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:j.exact.map(i=>t.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[t.jsx("span",{children:i}),t.jsx(U,{text:i,ariaLabel:"Copy exact COVESA match"})]},`exact-${i}`))})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Partial matches"}),t.jsx("td",{className:"v",children:j.partial.length===0?t.jsx("span",{children:"—"}):t.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:j.partial.map(i=>t.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[t.jsx("span",{children:i}),t.jsx(U,{text:i,ariaLabel:"Copy partial COVESA match"})]},`partial-${i}`))})})]})]})}),t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"aaos-section-title has-spacing",children:"SOME/IP Mapping"}),t.jsx("table",{className:"aaos-prop-table",children:t.jsxs("tbody",{children:[t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Service ID"}),t.jsx("td",{className:"v",children:t.jsx("input",{className:"aaos-edit-field",value:T,onChange:i=>x(i.target.value),placeholder:"Enter Service ID",spellCheck:!1})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Instance ID"}),t.jsx("td",{className:"v",children:t.jsx("input",{className:"aaos-edit-field",value:L,onChange:i=>C(i.target.value),placeholder:"Enter Instance ID",spellCheck:!1})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Event ID"}),t.jsx("td",{className:"v",children:t.jsx("input",{className:"aaos-edit-field",value:G,onChange:i=>d(i.target.value),placeholder:"Enter Event ID",spellCheck:!1})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Value"}),t.jsx("td",{className:"v",children:t.jsx("input",{className:"aaos-edit-field",value:E,onChange:i=>I(i.target.value),placeholder:pe?"Waiting for value from image...":B?"Press Get to request value":"Enter value to set",readOnly:!ra,spellCheck:!1})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Last Response Time"}),t.jsx("td",{className:"v",children:N?t.jsx("span",{className:"aaos-value-meta",children:N}):t.jsx("span",{className:"aaos-value-placeholder",children:"No response yet"})})]})]})}),t.jsxs("div",{className:"aaos-someip-actions",style:{marginTop:10},children:[t.jsx("button",{type:"button",disabled:!B,className:b("aaos-segment-btn",J==="get"&&B&&"is-active",!B&&"is-disabled"),onClick:oa,children:pe?"Getting...":"Get"}),t.jsx("button",{type:"button",disabled:!F,className:b("aaos-segment-btn",J==="set"&&F&&"is-active",!F&&"is-disabled"),onClick:ca,children:"Set"})]})]}),t.jsx("div",{className:"aaos-section-title has-spacing",children:"Property ID Composition"}),t.jsx("table",{className:"aaos-prop-table",children:t.jsxs("tbody",{children:[t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Base ID"}),t.jsx("td",{className:"v",children:a.baseId})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Group"}),t.jsx("td",{className:"v",children:"SYSTEM (0x10000000)"})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Vehicle Area"}),t.jsx("td",{className:"v",children:a.area})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Data Type"}),t.jsx("td",{className:"v",children:a.dataType})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Computed ID"}),t.jsx("td",{className:"v",children:Te})]})]})}),t.jsxs("div",{className:"aaos-actions",children:[t.jsxs("button",{type:"button",className:b("aaos-btn",!V&&"is-secondary"),onClick:da,disabled:!V||R.kind==="loading",title:V?`Register ${k} as a wishlist signal on this model`:"Wishlist API is unavailable in this context",children:[t.jsx(Ve,{}),R.kind==="loading"?"Adding…":"Add as wishlist signal"]}),t.jsx(U,{text:Ie,ariaLabel:"Copy full path"})]}),t.jsxs("div",{className:b("aaos-status",R.kind==="error"&&"is-error",R.kind==="success"&&"is-success",R.kind!=="error"&&R.kind!=="success"&&"is-info"),children:[R.kind==="success"&&R.message,R.kind==="error"&&R.message,R.kind==="idle"&&!V&&t.jsx("span",{children:s!=null&&s.createWishlistApi?"No model in context — wishlist signals require a model.":"Wishlist API not provided by host."})]})]})]})},aa=globalThis.React,{useState:ta}=aa,sa=({data:a,api:s})=>{var l;const[r,o]=ta(null),c=new Set(K.map(T=>T.group)).size,A=(l=a==null?void 0:a.model)==null?void 0:l.id;return t.jsxs("div",{className:"aaos-root",children:[t.jsxs("div",{className:"aaos-header",children:[t.jsxs("div",{className:"aaos-header-title",children:[t.jsx(te,{}),t.jsx("span",{children:"AAOS Vehicle Properties"})]}),t.jsx("div",{className:"aaos-header-right",children:t.jsxs("div",{className:"aaos-header-counter",children:[K.length," signals · ",c," groups"]})})]}),t.jsxs("div",{className:"aaos-body",children:[t.jsx(we,{signals:K,selectedSignal:r,onSelectSignal:o}),t.jsx("div",{className:"aaos-right",children:r?t.jsx(ea,{signal:r,api:s,modelId:A}):t.jsxs("div",{className:"aaos-placeholder",children:[t.jsx("div",{className:"aaos-placeholder-icon",children:t.jsx(te,{size:56})}),t.jsx("div",{className:"aaos-placeholder-title",children:"Select an AAOS signal to view its details"}),t.jsx("div",{className:"aaos-placeholder-sub",children:"Pick a signal from the list on the left"})]})})]})]})},Ae="aaos-plugin-styles",na=`
.aaos-root {
  --aaos-bg: #ffffff;
  --aaos-fg: #0f172a;
  --aaos-muted: #64748b;
