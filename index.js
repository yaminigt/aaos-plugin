(function(oe){"use strict";var F={exports:{}},y={};/**
 * @license React
...
`.trim(),be=s=>{const t=s.trim();return t===""||t==="—"||t==="-"||t.toLowerCase()==="n/a"},q=s=>{if(be(s))return[];const t=s.split(",").map(o=>o.trim()).flatMap(o=>o.includes(" / ")&&o.includes("Vehicle.")?o.split(" / ").map(l=>l.trim()):[o]).map(o=>o.trim()).filter(o=>o.length>0&&o!=="—"&&o!=="-"),n=new Set,i=[];for(const o of t)n.has(o)||(n.add(o),i.push(o));return i},fe=()=>{const s={};for(const t of ye.split(`
`)){const n=t.trim();if(!n)continue;const i=n.split("|").map(p=>p.trim()),o=i[0],l=q(i[1]||""),A=q(i[2]||"");o&&(s[o]={exact:l,partial:A})}return s};let H=null;const xe=s=>(H||(H=fe()),H[s]||{exact:[],partial:[]}),Ge={TIRE_PRESSURE:{serviceId:"0x4100",instanceId:"0x1000",operations:{get:{id:"0x8410",kind:"event",eventGroupId:"0x9410",transport:"reliable",port:"4100",updateCycleMs:3e3}},modes:["get"],notes:"Derived from vsomeip/vsomeip/tire_pressure_sample.json. This config exposes publish/subscribe events, not a writable SOME/IP method for SET."},CURRENT_GEAR:{serviceId:"0x2100",instanceId:"0x8210",modes:["get"]},PERF_VEHICLE_SPEED:{serviceId:"0x2100",instanceId:"0x8211",modes:["get"]}};function Me(s){return Ge[s]||null}const Ve=globalThis.React,{useEffect:W,useState:m}=Ve,C=(...s)=>s.filter(Boolean).join(" "),Be=s=>{switch(s){case"STRING":return"string";case"BOOLEAN":return"boolean";case"INT32":return"int32";case"INT32_VEC":return"int32[]";case"INT64":return"int64";case"INT64_VEC":return"int64[]";case"FLOAT":return"float";case"FLOAT_VEC":return"float[]";case"BYTES":return"uint8[]";case"MIXED":default:return"string"}},He=s=>s.access.includes("READ_WRITE")||s.access.includes("WRITE")?"actuator":"sensor",We=s=>`Aaos.${s.area}.${s.name}`,f=({text:s,ariaLabel:t})=>{const[n,i]=m(!1);W(()=>{if(!n)return;const l=setTimeout(()=>i(!1),1500);return()=>clearTimeout(l)},[n]);const o=async()=>{var l;try{if((l=navigator==null?void 0:navigator.clipboard)!=null&&l.writeText)await navigator.clipboard.writeText(s);else{const A=document.createElement("textarea");A.value=s,document.body.appendChild(A),A.select(),document.execCommand("copy"),document.body.removeChild(A)}i(!0)}catch(A){}};return a.jsx("button",{type:"button",className:C("aaos-copy-btn",n&&"is-done"),onClick:o,"aria-label":t||"Copy",title:n?"Copied!":"Copy",children:n?a.jsx(Le,{}):a.jsx(Se,{})})},X="aaos:someip:request",$="aaos:someip:value",we=s=>{const t=s.includes("READ")||s.includes("READ_WRITE"),n=s.includes("WRITE")||s.includes("READ_WRITE"),i=[];return t&&i.push("get"),n&&i.push("set"),i},Pe=({signal:s,api:t,modelId:n})=>{var se,te,ne,ie,re;const[i,o]=m({kind:"idle"}),[l,A]=m("get"),[p,D]=m(""),[u,g]=m(""),[w,d]=m(void 0),[E,_]=m(""),[N,L]=m(""),[Q,x]=m(!1),R=i,P=l,J=w,c=Me(s.name),O=we(s.access);(se=c==null?void 0:c.operations)==null||se[P],W(()=>{var I,h;o({kind:"idle"}),A("get"),D((I=c==null?void 0:c.serviceId)!=null?I:""),g((h=c==null?void 0:c.instanceId)!=null?h:""),d(void 0),_(""),L("");const r=O.includes("get")?"get":O.includes("set")?"set":"get";A(r),x(!1)},[s.name]),W(()=>{const r=I=>{const h=I,T=h==null?void 0:h.detail;!(T!=null&&T.signalName)||T.signalName!==s.name||(d(T.value===void 0?null:T.value),L(T.timestamp||new Date().toISOString()),x(!1))};return window.addEventListener($,r),()=>{window.removeEventListener($,r)}},[s.name]);const ee=Ne(s),ae=Re(s),G=We(s),M=xe(s.name),v=typeof(t==null?void 0:t.createWishlistApi)=="function"&&!!n,Ke=async()=>{var h;if(!O.includes("get"))return;const r=(h=c==null?void 0:c.operations)==null?void 0:h.get,I={signalName:s.name,mode:"get",someip:{serviceId:p||(c==null?void 0:c.serviceId)||"",instanceId:u||(c==null?void 0:c.instanceId)||"",operationId:r==null?void 0:r.id,eventGroupId:r==null?void 0:r.eventGroupId},requestedAt:new Date().toISOString()};A("get"),x(!0);try{typeof(t==null?void 0:t.sendSomeipPacket)=="function"&&await t.sendSomeipPacket(I)}catch(T){x(!1);const U=(T==null?void 0:T.message)||"Failed to send SOME/IP GET request package.";o({kind:"error",message:U})}window.dispatchEvent(new CustomEvent(X,{detail:I}))},ze=async()=>{var h;if(!O.includes("set"))return;const r=(h=c==null?void 0:c.operations)==null?void 0:h.set,I={signalName:s.name,mode:"set",value:E,someip:{serviceId:p||(c==null?void 0:c.serviceId)||"",instanceId:u||(c==null?void 0:c.instanceId)||"",operationId:r==null?void 0:r.id,eventGroupId:r==null?void 0:r.eventGroupId},requestedAt:new Date().toISOString()};A("set");try{typeof(t==null?void 0:t.sendSomeipPacket)=="function"&&await t.sendSomeipPacket(I)}catch(T){const U=(T==null?void 0:T.message)||"Failed to send SOME/IP SET request package.";o({kind:"error",message:U})}window.dispatchEvent(new CustomEvent(X,{detail:I}))},qe=async()=>{if(v)try{o({kind:"loading"}),await t.createWishlistApi({model:n,apiName:G,description:s.description,type:He(s),datatype:Be(s.dataType),skeleton:G,isWishlist:!0,...s.unit?{unit:s.unit}:{}}),o({kind:"success",message:`Added "${G}" as a wishlist signal.`})}catch(r){const I=(r==null?void 0:r.message)||"Failed to add as wishlist signal. See host toast.";o({kind:"error",message:I})}},V=[{key:"Signal",value:s.name},{key:"Group (Name)",value:s.group},{key:"Full Path",value:ae},{key:"Property ID",value:ee},{key:"Description",value:s.description},{key:"Change Mode",value:s.changeMode},{key:"Access",value:s.access.join(", ")},{key:"Vehicle Area",value:s.area},{key:"Data Type",value:s.dataType},{key:"VHAL Version",value:String(s.version)}];return s.unit&&V.push({key:"Unit",value:s.unit}),s.dataEnum&&s.dataEnum.length>0&&V.push({key:"Data Enum",value:s.dataEnum.join(", ")}),s.dataEnumBitFlags&&V.push({key:"Bit Flags",value:"data_enum_bit_flags"}),a.jsxs("div",{className:"aaos-detail",children:[a.jsxs("div",{className:"aaos-detail-bar",children:[a.jsxs("div",{className:"aaos-detail-name",children:[a.jsx("span",{children:s.name}),a.jsx(f,{text:s.name,ariaLabel:"Copy signal name"})]}),a.jsx("div",{className:"aaos-area-pill",children:s.area})]}),a.jsxs("div",{className:"aaos-detail-body",children:[a.jsx("div",{className:"aaos-section-title",children:"AAOS VehicleProperty"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsx("tbody",{children:V.map(r=>a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:r.key}),a.jsx("td",{className:"v",children:r.value})]},r.key))})}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"COVESA matching signals"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Exact matches"}),a.jsx("td",{className:"v",children:M.exact.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:M.exact.map(r=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:r}),a.jsx(f,{text:r,ariaLabel:"Copy exact COVESA match"})]},`exact-${r}`))})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Partial matches"}),a.jsx("td",{className:"v",children:M.partial.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:M.partial.map(r=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:r}),a.jsx(f,{text:r,ariaLabel:"Copy partial COVESA match"})]},`partial-${r}`))})})]})]})}),a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"aaos-section-title has-spacing",children:"SOME/IP Mapping"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Service ID"}),a.jsx("td",{className:"v",children:a.jsx("input",{className:"aaos-edit-field",value:p,onChange:r=>D(r.target.value),placeholder:"Enter Service ID",spellCheck:!1})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Instance ID"}),a.jsx("td",{className:"v",children:a.jsx("input",{className:"aaos-edit-field",value:u,onChange:r=>g(r.target.value),placeholder:"Enter Instance ID",spellCheck:!1})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Operation ID (GET)"}),a.jsx("td",{className:"v",children:((ne=(te=c==null?void 0:c.operations)==null?void 0:te.get)==null?void 0:ne.id)||"—"})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Operation ID (SET)"}),a.jsx("td",{className:"v",children:((re=(ie=c==null?void 0:c.operations)==null?void 0:ie.set)==null?void 0:re.id)||"—"})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Value"}),a.jsx("td",{className:"v",children:J===void 0?a.jsx("span",{className:"aaos-value-placeholder",children:Q?"Waiting for value from image...":"Press Get to request value"}):a.jsx("span",{className:"aaos-value-chip",children:String(J)})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Set Value"}),a.jsx("td",{className:"v",children:a.jsx("input",{className:"aaos-edit-field",value:E,onChange:r=>_(r.target.value),placeholder:"Enter value to set",spellCheck:!1})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Last Response Time"}),a.jsx("td",{className:"v",children:N?a.jsx("span",{className:"aaos-value-meta",children:N}):a.jsx("span",{className:"aaos-value-placeholder",children:"No response yet"})})]})]})}),a.jsxs("div",{className:"aaos-someip-actions",style:{marginTop:10},children:[a.jsx("button",{type:"button",disabled:!O.includes("get"),className:C("aaos-segment-btn",P==="get"&&O.includes("get")&&"is-active",!O.includes("get")&&"is-disabled"),onClick:Ke,children:Q?"Getting...":"Get"}),a.jsx("button",{type:"button",disabled:!O.includes("set"),className:C("aaos-segment-btn",P==="set"&&O.includes("set")&&"is-active",!O.includes("set")&&"is-disabled"),onClick:ze,children:"Set"})]})]}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"Property ID Composition"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Base ID"}),a.jsx("td",{className:"v",children:s.baseId})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Group"}),a.jsx("td",{className:"v",children:"SYSTEM (0x10000000)"})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Vehicle Area"}),a.jsx("td",{className:"v",children:s.area})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Data Type"}),a.jsx("td",{className:"v",children:s.dataType})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Computed ID"}),a.jsx("td",{className:"v",children:ee})]})]})}),a.jsxs("div",{className:"aaos-actions",children:[a.jsxs("button",{type:"button",className:C("aaos-btn",!v&&"is-secondary"),onClick:qe,disabled:!v||R.kind==="loading",title:v?`Register ${G} as a wishlist signal on this model`:"Wishlist API is unavailable in this context",children:[a.jsx(Ce,{}),R.kind==="loading"?"Adding…":"Add as wishlist signal"]}),a.jsx(f,{text:ae,ariaLabel:"Copy full path"})]}),a.jsxs("div",{className:C("aaos-status",R.kind==="error"&&"is-error",R.kind==="success"&&"is-success",R.kind!=="error"&&R.kind!=="success"&&"is-info"),children:[R.kind==="success"&&R.message,R.kind==="error"&&R.message,R.kind==="idle"&&!v&&a.jsx("span",{children:t!=null&&t.createWishlistApi?"No model in context — wishlist signals require a model.":"Wishlist API not provided by host."})]})]})]})},Ue=globalThis.React,{useState:Fe}=Ue,ke=({data:s,api:t})=>{var A;const[n,i]=Fe(null),o=new Set(B.map(p=>p.group)).size,l=(A=s==null?void 0:s.model)==null?void 0:A.id;return a.jsxs("div",{className:"aaos-root",children:[a.jsxs("div",{className:"aaos-header",children:[a.jsxs("div",{className:"aaos-header-title",children:[a.jsx(j,{}),a.jsx("span",{children:"AAOS Vehicle Properties"})]}),a.jsx("div",{className:"aaos-header-right",children:a.jsxs("div",{className:"aaos-header-counter",children:[B.length," signals · ",o," groups"]})})]}),a.jsxs("div",{className:"aaos-body",children:[a.jsx(ve,{signals:B,selectedSignal:n,onSelectSignal:i}),a.jsx("div",{className:"aaos-right",children:n?a.jsx(Pe,{signal:n,api:t,modelId:l}):a.jsxs("div",{className:"aaos-placeholder",children:[a.jsx("div",{className:"aaos-placeholder-icon",children:a.jsx(j,{size:56})}),a.jsx("div",{className:"aaos-placeholder-title",children:"Select an AAOS signal to view its details"}),a.jsx("div",{className:"aaos-placeholder-sub",children:"Pick a signal from the list on the left"})]})})]})]})},Z="aaos-plugin-styles",je=`
.aaos-root {
  --aaos-bg: #ffffff;
  --aaos-fg: #0f172a;
  --aaos-muted: #64748b;
...
`,Ye=()=>{if(typeof document=="undefined"||document.getElementById(Z))return;const s=document.createElement("style");s.id=Z,s.appendChild(document.createTextNode(je)),document.head.appendChild(s)};window.DAPlugins||(window.DAPlugins={}),window.DAPlugins["page-plugin"]={components:{Page:ke},unmount:s=>{s&&(s.innerHTML="")}},Ye()})(React);
