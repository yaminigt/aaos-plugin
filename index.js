(function(W){"use strict";var y={exports:{}},u={};/**
 * @license React
...
`.trim(),oe=s=>{const t=s.trim();return t===""||t==="—"||t==="-"||t.toLowerCase()==="n/a"},B=s=>{if(oe(s))return[];const t=s.split(",").map(r=>r.trim()).flatMap(r=>r.includes(" / ")&&r.includes("Vehicle.")?r.split(" / ").map(A=>A.trim()):[r]).map(r=>r.trim()).filter(r=>r.length>0&&r!=="—"&&r!=="-"),n=new Set,i=[];for(const r of t)n.has(r)||(n.add(r),i.push(r));return i},ce=()=>{const s={};for(const t of re.split(`
`)){const n=t.trim();if(!n)continue;const i=n.split("|").map(l=>l.trim()),r=i[0],A=B(i[1]||""),E=B(i[2]||"");r&&(s[r]={exact:A,partial:E})}return s};let C=null;const de=s=>(C||(C=ce()),C[s]||{exact:[],partial:[]}),Ee=[{signal:"Vehicle.Chassis.Axle.Wheel.Tire.Pressure",serviceId:"0x4100",instanceId:"0x1000",fieldIds:{get:"0x8410",set:"0x8411"}}],Ae=globalThis.React,{useEffect:V,useState:D}=Ae,O=(...s)=>s.filter(Boolean).join(" "),le=s=>{switch(s){case"STRING":return"string";case"BOOLEAN":return"boolean";case"INT32":return"int32";case"INT32_VEC":return"int32[]";case"INT64":return"int64";case"INT64_VEC":return"int64[]";case"FLOAT":return"float";case"FLOAT_VEC":return"float[]";case"BYTES":return"uint8[]";case"MIXED":default:return"string"}},Te=s=>s.access.includes("READ_WRITE")||s.access.includes("WRITE")?"actuator":"sensor",pe=s=>`Aaos.${s.area}.${s.name}`,S=({text:s,ariaLabel:t})=>{const[n,i]=D(!1);V(()=>{if(!n)return;const A=setTimeout(()=>i(!1),1500);return()=>clearTimeout(A)},[n]);const r=async()=>{var A;try{if((A=navigator==null?void 0:navigator.clipboard)!=null&&A.writeText)await navigator.clipboard.writeText(s);else{const E=document.createElement("textarea");E.value=s,document.body.appendChild(E),E.select(),document.execCommand("copy"),document.body.removeChild(E)}i(!0)}catch(E){}};return a.jsx("button",{type:"button",className:O("aaos-copy-btn",n&&"is-done"),onClick:r,"aria-label":t||"Copy",title:n?"Copied!":"Copy",children:n?a.jsx(se,{}):a.jsx(ae,{})})},Ie=({signal:s,api:t,modelId:n})=>{const[i,r]=D({kind:"idle"}),[A,E]=D({});V(()=>{r({kind:"idle"}),E({})},[s.name]);const l=X(s),m=$(s),h=pe(s),I=de(s.name),N=typeof(t==null?void 0:t.createWishlistApi)=="function"&&!!n,d=async()=>{if(N)try{r({kind:"loading"}),await t.createWishlistApi({model:n,apiName:h,description:s.description,type:Te(s),datatype:le(s.dataType),skeleton:h,isWishlist:!0,...s.unit?{unit:s.unit}:{}}),r({kind:"success",message:`Added "${h}" as a wishlist signal.`})}catch(o){const _=(o==null?void 0:o.message)||"Failed to add as wishlist signal. See host toast.";r({kind:"error",message:_})}},c=[{key:"Signal",value:s.name},{key:"Group (Name)",value:s.group},{key:"Full Path",value:m},{key:"Property ID",value:l},{key:"Description",value:s.description},{key:"Change Mode",value:s.changeMode},{key:"Access",value:s.access.join(", ")},{key:"Vehicle Area",value:s.area},{key:"Data Type",value:s.dataType},{key:"VHAL Version",value:String(s.version)}];s.unit&&c.push({key:"Unit",value:s.unit}),s.dataEnum&&s.dataEnum.length>0&&c.push({key:"Data Enum",value:s.dataEnum.join(", ")}),s.dataEnumBitFlags&&c.push({key:"Bit Flags",value:"data_enum_bit_flags"});const p=s.name==="TIRE_PRESSURE",T=(o,_)=>{E(v=>({...v,[o]:_}))};return a.jsxs("div",{className:"aaos-detail",children:[a.jsxs("div",{className:"aaos-detail-bar",children:[a.jsxs("div",{className:"aaos-detail-name",children:[a.jsx("span",{children:s.name}),a.jsx(S,{text:s.name,ariaLabel:"Copy signal name"})]}),a.jsx("div",{className:"aaos-area-pill",children:s.area})]}),a.jsxs("div",{className:"aaos-detail-body",children:[a.jsx("div",{className:"aaos-section-title",children:"AAOS VehicleProperty"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsx("tbody",{children:c.map(o=>a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:o.key}),a.jsx("td",{className:"v",children:o.value})]},o.key))})}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"COVESA matching signals"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Exact matches"}),a.jsx("td",{className:"v",children:I.exact.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:I.exact.map(o=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:o}),a.jsx(S,{text:o,ariaLabel:"Copy exact COVESA match"})]},`exact-${o}`))})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Partial matches"}),a.jsx("td",{className:"v",children:I.partial.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:I.partial.map(o=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:o}),a.jsx(S,{text:o,ariaLabel:"Copy partial COVESA match"})]},`partial-${o}`))})})]})]})}),p&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"aaos-section-title has-spacing",children:"SOME/IP tire pressure placeholder"}),a.jsx("div",{className:"aaos-someip-list",children:Ee.map(o=>{const _=A[o.signal]||"get",v=o.fieldIds[_];return a.jsxs("div",{className:"aaos-someip-card",children:[a.jsx("div",{className:"aaos-someip-path",children:o.signal}),a.jsxs("div",{className:"aaos-someip-meta",children:[a.jsxs("div",{children:["->"," Service ID: ",o.serviceId]}),a.jsxs("div",{children:["->"," Instance ID: ",o.instanceId]}),a.jsxs("div",{children:["->"," Field ID (",_.toUpperCase(),"): ",v]})]}),a.jsxs("div",{className:"aaos-someip-actions",children:[a.jsx("button",{type:"button",className:O("aaos-segment-btn",_==="get"&&"is-active"),onClick:()=>T(o.signal,"get"),children:"Get"}),a.jsx("button",{type:"button",className:O("aaos-segment-btn",_==="set"&&"is-active"),onClick:()=>T(o.signal,"set"),children:"Set"})]})]},o.signal)})})]}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"Property ID Composition"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Base ID"}),a.jsx("td",{className:"v",children:s.baseId})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Group"}),a.jsx("td",{className:"v",children:"SYSTEM (0x10000000)"})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Vehicle Area"}),a.jsx("td",{className:"v",children:s.area})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Data Type"}),a.jsx("td",{className:"v",children:s.dataType})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Computed ID"}),a.jsx("td",{className:"v",children:l})]})]})}),a.jsxs("div",{className:"aaos-actions",children:[a.jsxs("button",{type:"button",className:O("aaos-btn",!N&&"is-secondary"),onClick:d,disabled:!N||i.kind==="loading",title:N?`Register ${h} as a wishlist signal on this model`:"Wishlist API is unavailable in this context",children:[a.jsx(te,{}),i.kind==="loading"?"Adding…":"Add as wishlist signal"]}),a.jsx(S,{text:m,ariaLabel:"Copy full path"})]}),a.jsxs("div",{className:O("aaos-status",i.kind==="error"&&"is-error",i.kind==="success"&&"is-success",i.kind!=="error"&&i.kind!=="success"&&"is-info"),children:[i.kind==="success"&&i.message,i.kind==="error"&&i.message,i.kind==="idle"&&!N&&a.jsx("span",{children:t!=null&&t.createWishlistApi?"No model in context — wishlist signals require a model.":"Wishlist API not provided by host."})]})]})]})},he=globalThis.React,{useState:_e}=he,Ne=({data:s,api:t})=>{var E;const[n,i]=_e(null),r=new Set(g.map(l=>l.group)).size,A=(E=s==null?void 0:s.model)==null?void 0:E.id;return a.jsxs("div",{className:"aaos-root",children:[a.jsxs("div",{className:"aaos-header",children:[a.jsxs("div",{className:"aaos-header-title",children:[a.jsx(f,{}),a.jsx("span",{children:"AAOS Vehicle Properties"})]}),a.jsx("div",{className:"aaos-header-right",children:a.jsxs("div",{className:"aaos-header-counter",children:[g.length," signals · ",r," groups"]})})]}),a.jsxs("div",{className:"aaos-body",children:[a.jsx(ne,{signals:g,selectedSignal:n,onSelectSignal:i}),a.jsx("div",{className:"aaos-right",children:n?a.jsx(Ie,{signal:n,api:t,modelId:A}):a.jsxs("div",{className:"aaos-placeholder",children:[a.jsx("div",{className:"aaos-placeholder-icon",children:a.jsx(f,{size:56})}),a.jsx("div",{className:"aaos-placeholder-title",children:"Select an AAOS signal to view its details"}),a.jsx("div",{className:"aaos-placeholder-sub",children:"Pick a signal from the list on the left"})]})})]})]})},H="aaos-plugin-styles",Re=`
.aaos-root {
  --aaos-bg: #ffffff;
  --aaos-fg: #0f172a;
  --aaos-muted: #64748b;
...
`,Oe=()=>{if(typeof document=="undefined"||document.getElementById(H))return;const s=document.createElement("style");s.id=H,s.appendChild(document.createTextNode(Re)),document.head.appendChild(s)};window.DAPlugins||(window.DAPlugins={}),window.DAPlugins["page-plugin"]={components:{Page:Ne},unmount:s=>{s&&(s.innerHTML="")}},Oe()})(React);
