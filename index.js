(function(F){"use strict";var b={exports:{}},S={};/**
 * @license React
...
`.trim(),Ae=s=>{const t=s.trim();return t===""||t==="—"||t==="-"||t.toLowerCase()==="n/a"},V=s=>{if(Ae(s))return[];const t=s.split(",").map(r=>r.trim()).flatMap(r=>r.includes(" / ")&&r.includes("Vehicle.")?r.split(" / ").map(c=>c.trim()):[r]).map(r=>r.trim()).filter(r=>r.length>0&&r!=="—"&&r!=="-"),n=new Set,i=[];for(const r of t)n.has(r)||(n.add(r),i.push(r));return i},le=()=>{const s={};for(const t of Ee.split(`
`)){const n=t.trim();if(!n)continue;const i=n.split("|").map(A=>A.trim()),r=i[0],c=V(i[1]||""),E=V(i[2]||"");r&&(s[r]={exact:c,partial:E})}return s};let v=null;const Te=s=>(v||(v=le()),v[s]||{exact:[],partial:[]}),H={TIRE_PRESSURE:{serviceId:"0x4100",instanceId:"0x1000",operations:{get:{id:"0x8410",kind:"event",eventGroupId:"0x9410",transport:"reliable",port:"4100",updateCycleMs:3e3}},modes:["get"],notes:"Derived from vsomeip/vsomeip/tire_pressure_sample.json. This config exposes publish/subscribe events, not a writable SOME/IP method for SET."},CURRENT_GEAR:{serviceId:"0x2100",instanceId:"0x8210",modes:["get"]},PERF_VEHICLE_SPEED:{serviceId:"0x2100",instanceId:"0x8211",modes:["get"]}};function W(s){return H[s]||null}function pe(s,t,n){var c;const i=W(s),r=(c=i==null?void 0:i.operations)==null?void 0:c[t];return!i||!r||!i.modes.includes(t)?null:{aaosSignalName:s,mode:t,value:n,someip:{serviceId:i.serviceId,instanceId:i.instanceId,operationId:r.id,operationKind:r.kind,eventGroupId:r.eventGroupId,transport:r.transport,port:r.port,updateCycleMs:r.updateCycleMs}}}function Ie(s,t,n){var i;for(const[r,c]of Object.entries(H))if(!(c.serviceId!==s||c.instanceId!==t)){if(!n){const E=c.modes[0];return{aaosSignalName:r,mode:E,match:c}}for(const E of c.modes){const A=(i=c.operations)==null?void 0:i[E];if((A==null?void 0:A.id)===n)return{aaosSignalName:r,mode:E,match:c}}}return null}const he=globalThis.React,{useEffect:P,useState:y}=he,m=(...s)=>s.filter(Boolean).join(" "),_e=s=>{switch(s){case"STRING":return"string";case"BOOLEAN":return"boolean";case"INT32":return"int32";case"INT32_VEC":return"int32[]";case"INT64":return"int64";case"INT64_VEC":return"int64[]";case"FLOAT":return"float";case"FLOAT_VEC":return"float[]";case"BYTES":return"uint8[]";case"MIXED":default:return"string"}},Ne=s=>s.access.includes("READ_WRITE")||s.access.includes("WRITE")?"actuator":"sensor",Re=s=>`Aaos.${s.area}.${s.name}`,g=({text:s,ariaLabel:t})=>{const[n,i]=y(!1);P(()=>{if(!n)return;const c=setTimeout(()=>i(!1),1500);return()=>clearTimeout(c)},[n]);const r=async()=>{var c;try{if((c=navigator==null?void 0:navigator.clipboard)!=null&&c.writeText)await navigator.clipboard.writeText(s);else{const E=document.createElement("textarea");E.value=s,document.body.appendChild(E),E.select(),document.execCommand("copy"),document.body.removeChild(E)}i(!0)}catch(E){}};return a.jsx("button",{type:"button",className:m("aaos-copy-btn",n&&"is-done"),onClick:r,"aria-label":t||"Copy",title:n?"Copied!":"Copy",children:n?a.jsx(re,{}):a.jsx(ne,{})})},Oe=({signal:s,api:t,modelId:n})=>{var U;const[i,r]=y({kind:"idle"}),[c,E]=y("get"),A=i,I=c;P(()=>{r({kind:"idle"}),E("get")},[s.name]);const N=J(s),h=ee(s),R=Re(s),d=Te(s.name),o=W(s.name),l=(U=o==null?void 0:o.operations)==null?void 0:U[I],p=l?Ie(o.serviceId,o.instanceId,l.id):null,O=pe(s.name,I,s.dataType==="FLOAT"?220.5:null),u=typeof(t==null?void 0:t.createWishlistApi)=="function"&&!!n,Ce=async()=>{if(u)try{r({kind:"loading"}),await t.createWishlistApi({model:n,apiName:R,description:s.description,type:Ne(s),datatype:_e(s.dataType),skeleton:R,isWishlist:!0,...s.unit?{unit:s.unit}:{}}),r({kind:"success",message:`Added "${R}" as a wishlist signal.`})}catch(T){const De=(T==null?void 0:T.message)||"Failed to add as wishlist signal. See host toast.";r({kind:"error",message:De})}},C=[{key:"Signal",value:s.name},{key:"Group (Name)",value:s.group},{key:"Full Path",value:h},{key:"Property ID",value:N},{key:"Description",value:s.description},{key:"Change Mode",value:s.changeMode},{key:"Access",value:s.access.join(", ")},{key:"Vehicle Area",value:s.area},{key:"Data Type",value:s.dataType},{key:"VHAL Version",value:String(s.version)}];return s.unit&&C.push({key:"Unit",value:s.unit}),s.dataEnum&&s.dataEnum.length>0&&C.push({key:"Data Enum",value:s.dataEnum.join(", ")}),s.dataEnumBitFlags&&C.push({key:"Bit Flags",value:"data_enum_bit_flags"}),a.jsxs("div",{className:"aaos-detail",children:[a.jsxs("div",{className:"aaos-detail-bar",children:[a.jsxs("div",{className:"aaos-detail-name",children:[a.jsx("span",{children:s.name}),a.jsx(g,{text:s.name,ariaLabel:"Copy signal name"})]}),a.jsx("div",{className:"aaos-area-pill",children:s.area})]}),a.jsxs("div",{className:"aaos-detail-body",children:[a.jsx("div",{className:"aaos-section-title",children:"AAOS VehicleProperty"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsx("tbody",{children:C.map(T=>a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:T.key}),a.jsx("td",{className:"v",children:T.value})]},T.key))})}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"COVESA matching signals"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Exact matches"}),a.jsx("td",{className:"v",children:d.exact.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:d.exact.map(T=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:T}),a.jsx(g,{text:T,ariaLabel:"Copy exact COVESA match"})]},`exact-${T}`))})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Partial matches"}),a.jsx("td",{className:"v",children:d.partial.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:d.partial.map(T=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:T}),a.jsx(g,{text:T,ariaLabel:"Copy partial COVESA match"})]},`partial-${T}`))})})]})]})}),o&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"aaos-section-title has-spacing",children:"SOME/IP Mapping"}),a.jsxs("div",{className:"aaos-someip-card",children:[a.jsx("div",{className:"aaos-someip-path",children:s.name}),a.jsxs("div",{className:"aaos-someip-meta",children:[a.jsxs("div",{children:["->"," Service ID: ",o.serviceId]}),a.jsxs("div",{children:["->"," Instance ID: ",o.instanceId]}),l&&a.jsxs(a.Fragment,{children:[a.jsxs("div",{children:["->"," ",l.kind.toUpperCase()," ID (",I.toUpperCase(),"): ",l.id]}),l.eventGroupId&&a.jsxs("div",{children:["->"," Event Group ID: ",l.eventGroupId]}),l.transport&&a.jsxs("div",{children:["->"," Transport: ",l.transport]}),l.port&&a.jsxs("div",{children:["->"," Port: ",l.port]}),typeof l.updateCycleMs=="number"&&a.jsxs("div",{children:["->"," Update Cycle: ",l.updateCycleMs," ms"]})]}),o.notes&&a.jsxs("div",{children:["->"," Note: ",o.notes]})]}),a.jsxs("div",{className:"aaos-someip-actions",children:[a.jsx("button",{type:"button",disabled:!o.modes.includes("get"),className:m("aaos-segment-btn",I==="get"&&o.modes.includes("get")&&"is-active",!o.modes.includes("get")&&"is-disabled"),onClick:()=>o.modes.includes("get")&&E("get"),children:"Get"}),a.jsx("button",{type:"button",disabled:!o.modes.includes("set"),className:m("aaos-segment-btn",I==="set"&&o.modes.includes("set")&&"is-active",!o.modes.includes("set")&&"is-disabled"),onClick:()=>o.modes.includes("set")&&E("set"),children:"Set"})]}),O&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"aaos-someip-subtitle",children:"AAOS to SOME/IP envelope"}),a.jsx("pre",{className:"aaos-code-block",children:JSON.stringify(O,null,2)})]}),p&&l&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"aaos-someip-subtitle",children:"Reverse lookup"}),a.jsxs("div",{className:"aaos-someip-meta no-margin",children:[a.jsxs("div",{children:["->"," Incoming SOME/IP ",l.kind," ",l.id," on service ",o.serviceId," / instance ",o.instanceId]}),a.jsxs("div",{children:["->"," Maps back to AAOS signal: ",p.aaosSignalName]})]})]})]})]}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"Property ID Composition"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Base ID"}),a.jsx("td",{className:"v",children:s.baseId})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Group"}),a.jsx("td",{className:"v",children:"SYSTEM (0x10000000)"})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Vehicle Area"}),a.jsx("td",{className:"v",children:s.area})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Data Type"}),a.jsx("td",{className:"v",children:s.dataType})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Computed ID"}),a.jsx("td",{className:"v",children:N})]})]})}),a.jsxs("div",{className:"aaos-actions",children:[a.jsxs("button",{type:"button",className:m("aaos-btn",!u&&"is-secondary"),onClick:Ce,disabled:!u||A.kind==="loading",title:u?`Register ${R} as a wishlist signal on this model`:"Wishlist API is unavailable in this context",children:[a.jsx(oe,{}),A.kind==="loading"?"Adding…":"Add as wishlist signal"]}),a.jsx(g,{text:h,ariaLabel:"Copy full path"})]}),a.jsxs("div",{className:m("aaos-status",A.kind==="error"&&"is-error",A.kind==="success"&&"is-success",A.kind!=="error"&&A.kind!=="success"&&"is-info"),children:[A.kind==="success"&&A.message,A.kind==="error"&&A.message,A.kind==="idle"&&!u&&a.jsx("span",{children:t!=null&&t.createWishlistApi?"No model in context — wishlist signals require a model.":"Wishlist API not provided by host."})]})]})]})},me=globalThis.React,{useState:ue}=me,Se=({data:s,api:t})=>{var E;const[n,i]=ue(null),r=new Set(D.map(A=>A.group)).size,c=(E=s==null?void 0:s.model)==null?void 0:E.id;return a.jsxs("div",{className:"aaos-root",children:[a.jsxs("div",{className:"aaos-header",children:[a.jsxs("div",{className:"aaos-header-title",children:[a.jsx(x,{}),a.jsx("span",{children:"AAOS Vehicle Properties"})]}),a.jsx("div",{className:"aaos-header-right",children:a.jsxs("div",{className:"aaos-header-counter",children:[D.length," signals · ",r," groups"]})})]}),a.jsxs("div",{className:"aaos-body",children:[a.jsx(de,{signals:D,selectedSignal:n,onSelectSignal:i}),a.jsx("div",{className:"aaos-right",children:n?a.jsx(Oe,{signal:n,api:t,modelId:c}):a.jsxs("div",{className:"aaos-placeholder",children:[a.jsx("div",{className:"aaos-placeholder-icon",children:a.jsx(x,{size:56})}),a.jsx("div",{className:"aaos-placeholder-title",children:"Select an AAOS signal to view its details"}),a.jsx("div",{className:"aaos-placeholder-sub",children:"Pick a signal from the list on the left"})]})})]})]})},w="aaos-plugin-styles",Le=`
.aaos-root {
  --aaos-bg: #ffffff;
  --aaos-fg: #0f172a;
  --aaos-muted: #64748b;
...
`,ge=()=>{if(typeof document=="undefined"||document.getElementById(w))return;const s=document.createElement("style");s.id=w,s.appendChild(document.createTextNode(Le)),document.head.appendChild(s)};window.DAPlugins||(window.DAPlugins={}),window.DAPlugins["page-plugin"]={components:{Page:Se},unmount:s=>{s&&(s.innerHTML="")}},ge()})(React);
