...
`.trim(),ne=s=>{const t=s.trim();return t===""||t==="—"||t==="-"||t.toLowerCase()==="n/a"},G=s=>{if(ne(s))return[];const t=s.split(",").map(r=>r.trim()).flatMap(r=>r.includes(" / ")&&r.includes("Vehicle.")?r.split(" / ").map(E=>E.trim()):[r]).map(r=>r.trim()).filter(r=>r.length>0&&r!=="—"&&r!=="-"),n=new Set,i=[];for(const r of t)n.has(r)||(n.add(r),i.push(r));return i},re=()=>{const s={};for(const t of ie.split(`
`)){const n=t.trim();if(!n)continue;const i=n.split("|").map(l=>l.trim()),r=i[0],E=G(i[1]||""),A=G(i[2]||"");r&&(s[r]={exact:E,partial:A})}return s};let g=null;const oe=s=>(g||(g=re()),g[s]||{exact:[],partial:[]}),ce={TIRE_PRESSURE:{serviceId:"0x4100",instanceId:"0x1000",fieldIds:{get:"0x8410",set:"0x8411"}}};function de(s){return ce[s]||null}const Ee=globalThis.React,{useEffect:M,useState:C}=Ee,N=(...s)=>s.filter(Boolean).join(" "),Ae=s=>{switch(s){case"STRING":return"string";case"BOOLEAN":return"boolean";case"INT32":return"int32";case"INT32_VEC":return"int32[]";case"INT64":return"int64";case"INT64_VEC":return"int64[]";case"FLOAT":return"float";case"FLOAT_VEC":return"float[]";case"BYTES":return"uint8[]";case"MIXED":default:return"string"}},le=s=>s.access.includes("READ_WRITE")||s.access.includes("WRITE")?"actuator":"sensor",Te=s=>`Aaos.${s.area}.${s.name}`,L=({text:s,ariaLabel:t})=>{const[n,i]=C(!1);M(()=>{if(!n)return;const E=setTimeout(()=>i(!1),1500);return()=>clearTimeout(E)},[n]);const r=async()=>{var E;try{if((E=navigator==null?void 0:navigator.clipboard)!=null&&E.writeText)await navigator.clipboard.writeText(s);else{const A=document.createElement("textarea");A.value=s,document.body.appendChild(A),A.select(),document.execCommand("copy"),document.body.removeChild(A)}i(!0)}catch(A){}};return a.jsx("button",{type:"button",className:N("aaos-copy-btn",n&&"is-done"),onClick:r,"aria-label":t||"Copy",title:n?"Copied!":"Copy",children:n?a.jsx(ee,{}):a.jsx(J,{})})},pe=({signal:s,api:t,modelId:n})=>{const[i,r]=C({kind:"idle"}),[E,A]=C("get");M(()=>{r({kind:"idle"}),A("get")},[s.name]);const l=z(s),R=q(s),I=Te(s),p=oe(s.name),_=de(s.name),o=typeof(t==null?void 0:t.createWishlistApi)=="function"&&!!n,c=async()=>{if(o)try{r({kind:"loading"}),await t.createWishlistApi({model:n,apiName:I,description:s.description,type:le(s),datatype:Ae(s.dataType),skeleton:I,isWishlist:!0,...s.unit?{unit:s.unit}:{}}),r({kind:"success",message:`Added "${I}" as a wishlist signal.`})}catch(d){const O=(d==null?void 0:d.message)||"Failed to add as wishlist signal. See host toast.";r({kind:"error",message:O})}},T=[{key:"Signal",value:s.name},{key:"Group (Name)",value:s.group},{key:"Full Path",value:R},{key:"Property ID",value:l},{key:"Description",value:s.description},{key:"Change Mode",value:s.changeMode},{key:"Access",value:s.access.join(", ")},{key:"Vehicle Area",value:s.area},{key:"Data Type",value:s.dataType},{key:"VHAL Version",value:String(s.version)}];return s.unit&&T.push({key:"Unit",value:s.unit}),s.dataEnum&&s.dataEnum.length>0&&T.push({key:"Data Enum",value:s.dataEnum.join(", ")}),s.dataEnumBitFlags&&T.push({key:"Bit Flags",value:"data_enum_bit_flags"}),a.jsxs("div",{className:"aaos-detail",children:[a.jsxs("div",{className:"aaos-detail-bar",children:[a.jsxs("div",{className:"aaos-detail-name",children:[a.jsx("span",{children:s.name}),a.jsx(L,{text:s.name,ariaLabel:"Copy signal name"})]}),a.jsx("div",{className:"aaos-area-pill",children:s.area})]}),a.jsxs("div",{className:"aaos-detail-body",children:[a.jsx("div",{className:"aaos-section-title",children:"AAOS VehicleProperty"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsx("tbody",{children:T.map(d=>a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:d.key}),a.jsx("td",{className:"v",children:d.value})]},d.key))})}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"COVESA matching signals"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Exact matches"}),a.jsx("td",{className:"v",children:p.exact.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:p.exact.map(d=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:d}),a.jsx(L,{text:d,ariaLabel:"Copy exact COVESA match"})]},`exact-${d}`))})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Partial matches"}),a.jsx("td",{className:"v",children:p.partial.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:p.partial.map(d=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:d}),a.jsx(L,{text:d,ariaLabel:"Copy partial COVESA match"})]},`partial-${d}`))})})]})]})}),_&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"aaos-section-title has-spacing",children:"SOME/IP Mapping"}),a.jsxs("div",{className:"aaos-someip-card",children:[a.jsx("div",{className:"aaos-someip-path",children:s.name}),a.jsxs("div",{className:"aaos-someip-meta",children:[a.jsxs("div",{children:["->"," Service ID: ",_.serviceId]}),a.jsxs("div",{children:["->"," Instance ID: ",_.instanceId]}),a.jsxs("div",{children:["->"," Field ID (",E.toUpperCase(),"): ",_.fieldIds[E]]})]}),a.jsxs("div",{className:"aaos-someip-actions",children:[a.jsx("button",{type:"button",className:N("aaos-segment-btn",E==="get"&&"is-active"),onClick:()=>A("get"),children:"Get"}),a.jsx("button",{type:"button",className:N("aaos-segment-btn",E==="set"&&"is-active"),onClick:()=>A("set"),children:"Set"})]})]})]}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"Property ID Composition"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Base ID"}),a.jsx("td",{className:"v",children:s.baseId})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Group"}),a.jsx("td",{className:"v",children:"SYSTEM (0x10000000)"})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Vehicle Area"}),a.jsx("td",{className:"v",children:s.area})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Data Type"}),a.jsx("td",{className:"v",children:s.dataType})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Computed ID"}),a.jsx("td",{className:"v",children:l})]})]})}),a.jsxs("div",{className:"aaos-actions",children:[a.jsxs("button",{type:"button",className:N("aaos-btn",!o&&"is-secondary"),onClick:c,disabled:!o||i.kind==="loading",title:o?`Register ${I} as a wishlist signal on this model`:"Wishlist API is unavailable in this context",children:[a.jsx(ae,{}),i.kind==="loading"?"Adding…":"Add as wishlist signal"]}),a.jsx(L,{text:R,ariaLabel:"Copy full path"})]}),a.jsxs("div",{className:N("aaos-status",i.kind==="error"&&"is-error",i.kind==="success"&&"is-success",i.kind!=="error"&&i.kind!=="success"&&"is-info"),children:[i.kind==="success"&&i.message,i.kind==="error"&&i.message,i.kind==="idle"&&!o&&a.jsx("span",{children:t!=null&&t.createWishlistApi?"No model in context — wishlist signals require a model.":"Wishlist API not provided by host."})]})]})]})},Ie=globalThis.React,{useState:he}=Ie,_e=({data:s,api:t})=>{var A;const[n,i]=he(null),r=new Set(S.map(l=>l.group)).size,E=(A=s==null?void 0:s.model)==null?void 0:A.id;return a.jsxs("div",{className:"aaos-root",children:[a.jsxs("div",{className:"aaos-header",children:[a.jsxs("div",{className:"aaos-header-title",children:[a.jsx(y,{}),a.jsx("span",{children:"AAOS Vehicle Properties"})]}),a.jsx("div",{className:"aaos-header-right",children:a.jsxs("div",{className:"aaos-header-counter",children:[S.length," signals · ",r," groups"]})})]}),a.jsxs("div",{className:"aaos-body",children:[a.jsx(te,{signals:S,selectedSignal:n,onSelectSignal:i}),a.jsx("div",{className:"aaos-right",children:n?a.jsx(pe,{signal:n,api:t,modelId:E}):a.jsxs("div",{className:"aaos-placeholder",children:[a.jsx("div",{className:"aaos-placeholder-icon",children:a.jsx(y,{size:56})}),a.jsx("div",{className:"aaos-placeholder-title",children:"Select an AAOS signal to view its details"}),a.jsx("div",{className:"aaos-placeholder-sub",children:"Pick a signal from the list on the left"})]})})]})]})},B="aaos-plugin-styles",Ne=`
.aaos-root {
  --aaos-bg: #ffffff;
  --aaos-fg: #0f172a;
  --aaos-muted: #64748b;
