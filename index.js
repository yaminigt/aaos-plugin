...
`.trim(),Pe=a=>{const s=a.trim();return s===""||s==="—"||s==="-"||s.toLowerCase()==="n/a"},oe=a=>{if(Pe(a))return[];const s=a.split(",").map(c=>c.trim()).flatMap(c=>c.includes(" / ")&&c.includes("Vehicle.")?c.split(" / ").map(d=>d.trim()):[c]).map(c=>c.trim()).filter(c=>c.length>0&&c!=="—"&&c!=="-"),o=new Set,r=[];for(const c of s)o.has(c)||(o.add(c),r.push(c));return r},Ue=()=>{const a={};for(const s of We.split(`
`)){const o=s.trim();if(!o)continue;const r=o.split("|").map(p=>p.trim()),c=r[0],d=oe(r[1]||""),E=oe(r[2]||"");c&&(a[c]={exact:d,partial:E})}return a};let q=null;const Fe=a=>(q||(q=Ue()),q[a]||{exact:[],partial:[]}),ke={TIRE_PRESSURE:{serviceId:"0x4100",instanceId:"0x1000",operations:{get:{id:"0x8410",kind:"event",eventGroupId:"0x9410",transport:"reliable",port:"4100",updateCycleMs:3e3}},modes:["get"],notes:"Derived from vsomeip/vsomeip/tire_pressure_sample.json. This config exposes publish/subscribe events, not a writable SOME/IP method for SET."},CURRENT_GEAR:{serviceId:"0x2100",instanceId:"0x8210",modes:["get"]},PERF_VEHICLE_SPEED:{serviceId:"0x2100",instanceId:"0x8211",modes:["get"]}};function je(a){return ke[a]||null}const z="http://localhost:3201",Ye="ws://localhost:3201/aaos-ws",re=[1e3,2e3,4e3,8e3,16e3,3e4],$="aaos:signal:update",X="aaos:someip:value";let O=null,W=0,P=!1;function m(a){console.info(`[aaosBridge WS] ${a}`)}function ce(a){window.dispatchEvent(new CustomEvent($,{detail:a})),window.dispatchEvent(new CustomEvent(X,{detail:a}))}function de(){const a=re[Math.min(W,re.length-1)];W++,m(`Reconnecting in ${a}ms (attempt ${W})…`),setTimeout(()=>{P&&Ee()},a)}function Ee(){if(typeof WebSocket=="undefined")return m("WebSocket not available in this environment."),null;P=!0;try{O=new WebSocket(Ye)}catch(a){return m(`Failed to construct WebSocket: ${a}`),de(),null}return O.onopen=()=>{W=0,m("Connected to backend bridge server.")},O.onmessage=a=>{var s,o,r,c;try{const d=JSON.parse(a.data);let E=null;if((d==null?void 0:d.event)==="aaos:response"&&(d!=null&&d.data)){const p=d.data,S=(s=p==null?void 0:p.payload)!=null?s:{};E={signalName:(o=S.signalName)!=null?o:"",value:(r=S.value)!=null?r:null,timestamp:(c=p==null?void 0:p.timestamp)!=null?c:new Date().toISOString(),source:"websocket"}}else d!=null&&d.signalName&&(E=d);if(!(E!=null&&E.signalName)){m("Received message missing signalName — skipped.");return}m(`Signal update received: ${E.signalName} = ${E.value}`),ce(E)}catch(d){m("Failed to parse incoming WebSocket message.")}},O.onerror=a=>{m(`WebSocket error: ${JSON.stringify(a)}`)},O.onclose=a=>{m(`WebSocket closed (code: ${a.code}, reason: ${a.reason||"none"}).`),O=null,P&&de()},O}function Ke(){P=!1,O&&(O.close(),O=null)}async function qe(a){try{const s=await fetch(`${z}/v2/aaos/request`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)});if(!s.ok)return console.error(`[aaosBridge] POST /v2/aaos/request failed: ${s.status} ${s.statusText}`),null;const o=await s.json();return o!=null&&o.signalName&&o.value!==void 0&&ce(o),o}catch(s){return console.error("[aaosBridge] sendRequest error:",s),null}}async function ze(a){try{const s=a?`${z}/v2/aaos/latest?signal=${encodeURIComponent(a)}`:`${z}/v2/aaos/latest`,o=await fetch(s);return o.ok?await o.json():(console.error(`[aaosBridge] GET /v2/aaos/latest failed: ${o.status} ${o.statusText}`),null)}catch(s){return console.error("[aaosBridge] getLatestResponse error:",s),null}}const Z={sendRequest:qe,getLatestResponse:ze,connectWebSocket:Ee,disconnectWebSocket:Ke},$e=globalThis.React,{useEffect:Q,useState:g}=$e,x=(...a)=>a.filter(Boolean).join(" "),Xe=a=>{switch(a){case"STRING":return"string";case"BOOLEAN":return"boolean";case"INT32":return"int32";case"INT32_VEC":return"int32[]";case"INT64":return"int64";case"INT64_VEC":return"int64[]";case"FLOAT":return"float";case"FLOAT_VEC":return"float[]";case"BYTES":return"uint8[]";case"MIXED":default:return"string"}},Ze=a=>a.access.includes("READ_WRITE")||a.access.includes("WRITE")?"actuator":"sensor",Qe=a=>`Aaos.${a.area}.${a.name}`,U=({text:a,ariaLabel:s})=>{const[o,r]=g(!1);Q(()=>{if(!o)return;const d=setTimeout(()=>r(!1),1500);return()=>clearTimeout(d)},[o]);const c=async()=>{var d;try{if((d=navigator==null?void 0:navigator.clipboard)!=null&&d.writeText)await navigator.clipboard.writeText(a);else{const E=document.createElement("textarea");E.value=a,document.body.appendChild(E),E.select(),document.execCommand("copy"),document.body.removeChild(E)}r(!0)}catch(E){}};return t.jsx("button",{type:"button",className:x("aaos-copy-btn",o&&"is-done"),onClick:c,"aria-label":s||"Copy",title:o?"Copied!":"Copy",children:o?t.jsx(Be,{}):t.jsx(Me,{})})},le="aaos:someip:request";Z.connectWebSocket();const Je=a=>{const s=a.includes("READ")||a.includes("READ_WRITE"),o=a.includes("WRITE")||a.includes("READ_WRITE"),r=[];return s&&r.push("get"),o&&r.push("set"),r},ea=({signal:a,api:s,modelId:o})=>{var he;const[r,c]=g({kind:"idle"}),[d,E]=g("get"),[p,S]=g(""),[C,D]=g(""),[G,l]=g(""),[A,I]=g(""),[N,y]=g(""),[pe,f]=g(!1),R=r,J=d,n=je(a.name),M=Je(a.access),B=M.includes("get"),F=M.includes("set"),oa=F;(he=n==null?void 0:n.operations)==null||he[J],Q(()=>{var h,_,T,L,u,b;c({kind:"idle"}),E("get"),S((h=n==null?void 0:n.serviceId)!=null?h:""),D((_=n==null?void 0:n.instanceId)!=null?_:""),l(((L=(T=n==null?void 0:n.operations)==null?void 0:T.get)==null?void 0:L.id)||((b=(u=n==null?void 0:n.operations)==null?void 0:u.set)==null?void 0:b.id)||""),I(""),y("");const i=M.includes("get")?"get":M.includes("set")?"set":"get";E(i),f(!1)},[a.name]),Q(()=>{const i=h=>{const _=h,T=_==null?void 0:_.detail;!(T!=null&&T.signalName)||T.signalName!==a.name||(I(T.value===void 0?"":String(T.value)),y(T.timestamp||new Date().toISOString()),f(!1))};return window.addEventListener($,i),window.addEventListener(X,i),()=>{window.removeEventListener($,i),window.removeEventListener(X,i)}},[a.name]);const Te=ve(a),Ie=ye(a),k=Qe(a),j=Fe(a.name),V=typeof(s==null?void 0:s.createWishlistApi)=="function"&&!!o,ra=async()=>{var _,T,L;if(!B)return;const i=(_=n==null?void 0:n.operations)==null?void 0:_.get,h={signalName:a.name,mode:"get",someip:{serviceId:p||(n==null?void 0:n.serviceId)||"",instanceId:C||(n==null?void 0:n.instanceId)||"",operationId:G||(i==null?void 0:i.id),operationKind:i==null?void 0:i.kind,eventGroupId:i==null?void 0:i.eventGroupId,transport:i==null?void 0:i.transport,port:i==null?void 0:i.port,updateCycleMs:i==null?void 0:i.updateCycleMs,operations:{get:(T=n==null?void 0:n.operations)!=null&&T.get?{id:n.operations.get.id,kind:n.operations.get.kind,eventGroupId:n.operations.get.eventGroupId,transport:n.operations.get.transport,port:n.operations.get.port,updateCycleMs:n.operations.get.updateCycleMs}:void 0,set:(L=n==null?void 0:n.operations)!=null&&L.set?{id:n.operations.set.id,kind:n.operations.set.kind,eventGroupId:n.operations.set.eventGroupId,transport:n.operations.set.transport,port:n.operations.set.port,updateCycleMs:n.operations.set.updateCycleMs}:void 0}},requestedAt:new Date().toISOString()};E("get"),f(!0);try{await Z.sendRequest(h)}catch(u){f(!1);const b=(u==null?void 0:u.message)||"Failed to send SOME/IP GET request package.";c({kind:"error",message:b})}window.dispatchEvent(new CustomEvent(le,{detail:h}))},ca=async()=>{var _,T,L;if(!M.includes("set"))return;const i=(_=n==null?void 0:n.operations)==null?void 0:_.set,h={signalName:a.name,mode:"set",value:A,someip:{serviceId:p||(n==null?void 0:n.serviceId)||"",instanceId:C||(n==null?void 0:n.instanceId)||"",operationId:G||(i==null?void 0:i.id),operationKind:i==null?void 0:i.kind,eventGroupId:i==null?void 0:i.eventGroupId,transport:i==null?void 0:i.transport,port:i==null?void 0:i.port,updateCycleMs:i==null?void 0:i.updateCycleMs,operations:{get:(T=n==null?void 0:n.operations)!=null&&T.get?{id:n.operations.get.id,kind:n.operations.get.kind,eventGroupId:n.operations.get.eventGroupId,transport:n.operations.get.transport,port:n.operations.get.port,updateCycleMs:n.operations.get.updateCycleMs}:void 0,set:(L=n==null?void 0:n.operations)!=null&&L.set?{id:n.operations.set.id,kind:n.operations.set.kind,eventGroupId:n.operations.set.eventGroupId,transport:n.operations.set.transport,port:n.operations.set.port,updateCycleMs:n.operations.set.updateCycleMs}:void 0}},requestedAt:new Date().toISOString()};E("set"),f(!0);try{await Z.sendRequest(h)}catch(u){f(!1);const b=(u==null?void 0:u.message)||"Failed to send SOME/IP SET request package.";c({kind:"error",message:b})}window.dispatchEvent(new CustomEvent(le,{detail:h}))},da=async()=>{if(V)try{c({kind:"loading"}),await s.createWishlistApi({model:o,apiName:k,description:a.description,type:Ze(a),datatype:Xe(a.dataType),skeleton:k,isWishlist:!0,...a.unit?{unit:a.unit}:{}}),c({kind:"success",message:`Added "${k}" as a wishlist signal.`})}catch(i){const h=(i==null?void 0:i.message)||"Failed to add as wishlist signal. See host toast.";c({kind:"error",message:h})}},Y=[{key:"Signal",value:a.name},{key:"Group (Name)",value:a.group},{key:"Full Path",value:Ie},{key:"Property ID",value:Te},{key:"Description",value:a.description},{key:"Change Mode",value:a.changeMode},{key:"Access",value:a.access.join(", ")},{key:"Vehicle Area",value:a.area},{key:"Data Type",value:a.dataType},{key:"VHAL Version",value:String(a.version)}];return a.unit&&Y.push({key:"Unit",value:a.unit}),a.dataEnum&&a.dataEnum.length>0&&Y.push({key:"Data Enum",value:a.dataEnum.join(", ")}),a.dataEnumBitFlags&&Y.push({key:"Bit Flags",value:"data_enum_bit_flags"}),t.jsxs("div",{className:"aaos-detail",children:[t.jsxs("div",{className:"aaos-detail-bar",children:[t.jsxs("div",{className:"aaos-detail-name",children:[t.jsx("span",{children:a.name}),t.jsx(U,{text:a.name,ariaLabel:"Copy signal name"})]}),t.jsx("div",{className:"aaos-area-pill",children:a.area})]}),t.jsxs("div",{className:"aaos-detail-body",children:[t.jsx("div",{className:"aaos-section-title",children:"AAOS VehicleProperty"}),t.jsx("table",{className:"aaos-prop-table",children:t.jsx("tbody",{children:Y.map(i=>t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:i.key}),t.jsx("td",{className:"v",children:i.value})]},i.key))})}),t.jsx("div",{className:"aaos-section-title has-spacing",children:"COVESA matching signals"}),t.jsx("table",{className:"aaos-prop-table",children:t.jsxs("tbody",{children:[t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Exact matches"}),t.jsx("td",{className:"v",children:j.exact.length===0?t.jsx("span",{children:"—"}):t.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:j.exact.map(i=>t.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[t.jsx("span",{children:i}),t.jsx(U,{text:i,ariaLabel:"Copy exact COVESA match"})]},`exact-${i}`))})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Partial matches"}),t.jsx("td",{className:"v",children:j.partial.length===0?t.jsx("span",{children:"—"}):t.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:j.partial.map(i=>t.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[t.jsx("span",{children:i}),t.jsx(U,{text:i,ariaLabel:"Copy partial COVESA match"})]},`partial-${i}`))})})]})]})}),t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"aaos-section-title has-spacing",children:"SOME/IP Mapping"}),t.jsx("table",{className:"aaos-prop-table",children:t.jsxs("tbody",{children:[t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Service ID"}),t.jsx("td",{className:"v",children:t.jsx("input",{className:"aaos-edit-field",value:p,onChange:i=>S(i.target.value),placeholder:"Enter Service ID",spellCheck:!1})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Instance ID"}),t.jsx("td",{className:"v",children:t.jsx("input",{className:"aaos-edit-field",value:C,onChange:i=>D(i.target.value),placeholder:"Enter Instance ID",spellCheck:!1})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Event ID"}),t.jsx("td",{className:"v",children:t.jsx("input",{className:"aaos-edit-field",value:G,onChange:i=>l(i.target.value),placeholder:"Enter Event ID",spellCheck:!1})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Value"}),t.jsx("td",{className:"v",children:t.jsx("input",{className:"aaos-edit-field",value:A,onChange:i=>I(i.target.value),placeholder:pe?"Waiting for value from image...":B?"Press Get to request value":"Enter value to set",readOnly:!oa,spellCheck:!1})})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Last Response Time"}),t.jsx("td",{className:"v",children:N?t.jsx("span",{className:"aaos-value-meta",children:N}):t.jsx("span",{className:"aaos-value-placeholder",children:"No response yet"})})]})]})}),t.jsxs("div",{className:"aaos-someip-actions",style:{marginTop:10},children:[t.jsx("button",{type:"button",disabled:!B,className:x("aaos-segment-btn",J==="get"&&B&&"is-active",!B&&"is-disabled"),onClick:ra,children:pe?"Getting...":"Get"}),t.jsx("button",{type:"button",disabled:!F,className:x("aaos-segment-btn",J==="set"&&F&&"is-active",!F&&"is-disabled"),onClick:ca,children:"Set"})]})]}),t.jsx("div",{className:"aaos-section-title has-spacing",children:"Property ID Composition"}),t.jsx("table",{className:"aaos-prop-table",children:t.jsxs("tbody",{children:[t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Base ID"}),t.jsx("td",{className:"v",children:a.baseId})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Group"}),t.jsx("td",{className:"v",children:"SYSTEM (0x10000000)"})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Vehicle Area"}),t.jsx("td",{className:"v",children:a.area})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Data Type"}),t.jsx("td",{className:"v",children:a.dataType})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"k",children:"Computed ID"}),t.jsx("td",{className:"v",children:Te})]})]})}),t.jsxs("div",{className:"aaos-actions",children:[t.jsxs("button",{type:"button",className:x("aaos-btn",!V&&"is-secondary"),onClick:da,disabled:!V||R.kind==="loading",title:V?`Register ${k} as a wishlist signal on this model`:"Wishlist API is unavailable in this context",children:[t.jsx(Ve,{}),R.kind==="loading"?"Adding…":"Add as wishlist signal"]}),t.jsx(U,{text:Ie,ariaLabel:"Copy full path"})]}),t.jsxs("div",{className:x("aaos-status",R.kind==="error"&&"is-error",R.kind==="success"&&"is-success",R.kind!=="error"&&R.kind!=="success"&&"is-info"),children:[R.kind==="success"&&R.message,R.kind==="error"&&R.message,R.kind==="idle"&&!V&&t.jsx("span",{children:s!=null&&s.createWishlistApi?"No model in context — wishlist signals require a model.":"Wishlist API not provided by host."})]})]})]})},aa=globalThis.React,{useState:ta}=aa,sa=({data:a,api:s})=>{var E;const[o,r]=ta(null),c=new Set(K.map(p=>p.group)).size,d=(E=a==null?void 0:a.model)==null?void 0:E.id;return t.jsxs("div",{className:"aaos-root",children:[t.jsxs("div",{className:"aaos-header",children:[t.jsxs("div",{className:"aaos-header-title",children:[t.jsx(te,{}),t.jsx("span",{children:"AAOS Vehicle Properties"})]}),t.jsx("div",{className:"aaos-header-right",children:t.jsxs("div",{className:"aaos-header-counter",children:[K.length," signals · ",c," groups"]})})]}),t.jsxs("div",{className:"aaos-body",children:[t.jsx(we,{signals:K,selectedSignal:o,onSelectSignal:r}),t.jsx("div",{className:"aaos-right",children:o?t.jsx(ea,{signal:o,api:s,modelId:d}):t.jsxs("div",{className:"aaos-placeholder",children:[t.jsx("div",{className:"aaos-placeholder-icon",children:t.jsx(te,{size:56})}),t.jsx("div",{className:"aaos-placeholder-title",children:"Select an AAOS signal to view its details"}),t.jsx("div",{className:"aaos-placeholder-sub",children:"Pick a signal from the list on the left"})]})})]})]})},Ae="aaos-plugin-styles",na=`
.aaos-root {
  --aaos-bg: #ffffff;
  --aaos-fg: #0f172a;
  --aaos-muted: #64748b;
