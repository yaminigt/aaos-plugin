(function(V){"use strict";var C={exports:{}},R={};/**
 * @license React
...
`.trim(),ne=t=>{const s=t.trim();return s===""||s==="—"||s==="-"||s.toLowerCase()==="n/a"},f=t=>{if(ne(t))return[];const s=t.split(",").map(o=>o.trim()).flatMap(o=>o.includes(" / ")&&o.includes("Vehicle.")?o.split(" / ").map(E=>E.trim()):[o]).map(o=>o.trim()).filter(o=>o.length>0&&o!=="—"&&o!=="-"),n=new Set,i=[];for(const o of s)n.has(o)||(n.add(o),i.push(o));return i},re=()=>{const t={};for(const s of ie.split(`
`)){const n=s.trim();if(!n)continue;const i=n.split("|").map(A=>A.trim()),o=i[0],E=f(i[1]||""),d=f(i[2]||"");o&&(t[o]={exact:E,partial:d})}return t};let u=null;const oe=t=>(u||(u=re()),u[t]||{exact:[],partial:[]}),ce=globalThis.React,{useEffect:x,useState:M}=ce,S=(...t)=>t.filter(Boolean).join(" "),de=t=>{switch(t){case"STRING":return"string";case"BOOLEAN":return"boolean";case"INT32":return"int32";case"INT32_VEC":return"int32[]";case"INT64":return"int64";case"INT64_VEC":return"int64[]";case"FLOAT":return"float";case"FLOAT_VEC":return"float[]";case"BYTES":return"uint8[]";case"MIXED":default:return"string"}},Ee=t=>t.access.includes("READ_WRITE")||t.access.includes("WRITE")?"actuator":"sensor",Ae=t=>`Aaos.${t.area}.${t.name}`,m=({text:t,ariaLabel:s})=>{const[n,i]=M(!1);x(()=>{if(!n)return;const E=setTimeout(()=>i(!1),1500);return()=>clearTimeout(E)},[n]);const o=async()=>{var E;try{if((E=navigator==null?void 0:navigator.clipboard)!=null&&E.writeText)await navigator.clipboard.writeText(t);else{const d=document.createElement("textarea");d.value=t,document.body.appendChild(d),d.select(),document.execCommand("copy"),document.body.removeChild(d)}i(!0)}catch(d){}};return a.jsx("button",{type:"button",className:S("aaos-copy-btn",n&&"is-done"),onClick:o,"aria-label":s||"Copy",title:n?"Copied!":"Copy",children:n?a.jsx(ee,{}):a.jsx(J,{})})},le=({signal:t,api:s,modelId:n})=>{const[i,o]=M({kind:"idle"});x(()=>{o({kind:"idle"})},[t.name]);const E=z(t),d=q(t),A=Ae(t),I=oe(t.name),l=typeof(s==null?void 0:s.createWishlistApi)=="function"&&!!n,_=async()=>{if(l)try{o({kind:"loading"}),await s.createWishlistApi({model:n,apiName:A,description:t.description,type:Ee(t),datatype:de(t.dataType),skeleton:A,isWishlist:!0,...t.unit?{unit:t.unit}:{}}),o({kind:"success",message:`Added "${A}" as a wishlist signal.`})}catch(r){const c=(r==null?void 0:r.message)||"Failed to add as wishlist signal. See host toast.";o({kind:"error",message:c})}},N=[{key:"Signal",value:t.name},{key:"Group (Name)",value:t.group},{key:"Full Path",value:d},{key:"Property ID",value:E},{key:"Description",value:t.description},{key:"Change Mode",value:t.changeMode},{key:"Access",value:t.access.join(", ")},{key:"Vehicle Area",value:t.area},{key:"Data Type",value:t.dataType},{key:"VHAL Version",value:String(t.version)}];return t.unit&&N.push({key:"Unit",value:t.unit}),t.dataEnum&&t.dataEnum.length>0&&N.push({key:"Data Enum",value:t.dataEnum.join(", ")}),t.dataEnumBitFlags&&N.push({key:"Bit Flags",value:"data_enum_bit_flags"}),a.jsxs("div",{className:"aaos-detail",children:[a.jsxs("div",{className:"aaos-detail-bar",children:[a.jsxs("div",{className:"aaos-detail-name",children:[a.jsx("span",{children:t.name}),a.jsx(m,{text:t.name,ariaLabel:"Copy signal name"})]}),a.jsx("div",{className:"aaos-area-pill",children:t.area})]}),a.jsxs("div",{className:"aaos-detail-body",children:[a.jsx("div",{className:"aaos-section-title",children:"AAOS VehicleProperty"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsx("tbody",{children:N.map(r=>a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:r.key}),a.jsx("td",{className:"v",children:r.value})]},r.key))})}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"COVESA matching signals"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Exact matches"}),a.jsx("td",{className:"v",children:I.exact.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:I.exact.map(r=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:r}),a.jsx(m,{text:r,ariaLabel:"Copy exact COVESA match"})]},`exact-${r}`))})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Partial matches"}),a.jsx("td",{className:"v",children:I.partial.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:I.partial.map(r=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:r}),a.jsx(m,{text:r,ariaLabel:"Copy partial COVESA match"})]},`partial-${r}`))})})]})]})}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"Property ID Composition"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Base ID"}),a.jsx("td",{className:"v",children:t.baseId})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Group"}),a.jsx("td",{className:"v",children:"SYSTEM (0x10000000)"})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Vehicle Area"}),a.jsx("td",{className:"v",children:t.area})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Data Type"}),a.jsx("td",{className:"v",children:t.dataType})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Computed ID"}),a.jsx("td",{className:"v",children:E})]})]})}),a.jsxs("div",{className:"aaos-actions",children:[a.jsxs("button",{type:"button",className:S("aaos-btn",!l&&"is-secondary"),onClick:_,disabled:!l||i.kind==="loading",title:l?`Register ${A} as a wishlist signal on this model`:"Wishlist API is unavailable in this context",children:[a.jsx(ae,{}),i.kind==="loading"?"Adding…":"Add as wishlist signal"]}),a.jsx(m,{text:d,ariaLabel:"Copy full path"})]}),a.jsxs("div",{className:S("aaos-status",i.kind==="error"&&"is-error",i.kind==="success"&&"is-success",i.kind!=="error"&&i.kind!=="success"&&"is-info"),children:[i.kind==="success"&&i.message,i.kind==="error"&&i.message,i.kind==="idle"&&!l&&a.jsx("span",{children:s!=null&&s.createWishlistApi?"No model in context — wishlist signals require a model.":"Wishlist API not provided by host."})]})]})]})},Te=globalThis.React,{useState:pe}=Te,Ie=({data:t,api:s})=>{var d;const[n,i]=pe(null),o=new Set(L.map(A=>A.group)).size,E=(d=t==null?void 0:t.model)==null?void 0:d.id;return a.jsxs("div",{className:"aaos-root",children:[a.jsxs("div",{className:"aaos-header",children:[a.jsxs("div",{className:"aaos-header-title",children:[a.jsx(v,{}),a.jsx("span",{children:"AAOS Vehicle Properties"})]}),a.jsx("div",{className:"aaos-header-right",children:a.jsxs("div",{className:"aaos-header-counter",children:[L.length," signals · ",o," groups"]})})]}),a.jsxs("div",{className:"aaos-body",children:[a.jsx(se,{signals:L,selectedSignal:n,onSelectSignal:i}),a.jsx("div",{className:"aaos-right",children:n?a.jsx(le,{signal:n,api:s,modelId:E}):a.jsxs("div",{className:"aaos-placeholder",children:[a.jsx("div",{className:"aaos-placeholder-icon",children:a.jsx(v,{size:56})}),a.jsx("div",{className:"aaos-placeholder-title",children:"Select an AAOS signal to view its details"}),a.jsx("div",{className:"aaos-placeholder-sub",children:"Pick a signal from the list on the left"})]})})]})]})},B="aaos-plugin-styles",he=`
.aaos-root {
  --aaos-bg: #ffffff;
  --aaos-fg: #0f172a;
  --aaos-muted: #64748b;
...
`,_e=()=>{if(typeof document=="undefined"||document.getElementById(B))return;const t=document.createElement("style");t.id=B,t.appendChild(document.createTextNode(he)),document.head.appendChild(t)};window.DAPlugins||(window.DAPlugins={}),window.DAPlugins["page-plugin"]={components:{Page:Ie},unmount:t=>{t&&(t.innerHTML="")}},_e()})(React);
