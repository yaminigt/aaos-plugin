(function($){"use strict";var W={exports:{}},D={};/**
 * @license React
...
`.trim(),Re=s=>{const t=s.trim();return t===""||t==="—"||t==="-"||t.toLowerCase()==="n/a"},j=s=>{if(Re(s))return[];const t=s.split(",").map(r=>r.trim()).flatMap(r=>r.includes(" / ")&&r.includes("Vehicle.")?r.split(" / ").map(l=>l.trim()):[r]).map(r=>r.trim()).filter(r=>r.length>0&&r!=="—"&&r!=="-"),i=new Set,n=[];for(const r of t)i.has(r)||(i.add(r),n.push(r));return n},Oe=()=>{const s={};for(const t of Ne.split(`
`)){const i=t.trim();if(!i)continue;const n=i.split("|").map(p=>p.trim()),r=n[0],l=j(n[1]||""),E=j(n[2]||"");r&&(s[r]={exact:l,partial:E})}return s};let B=null;const me=s=>(B||(B=Oe()),B[s]||{exact:[],partial:[]}),ue={TIRE_PRESSURE:{serviceId:"0x4100",instanceId:"0x1000",operations:{get:{id:"0x8410",kind:"event",eventGroupId:"0x9410",transport:"reliable",port:"4100",updateCycleMs:3e3}},modes:["get"],notes:"Derived from vsomeip/vsomeip/tire_pressure_sample.json. This config exposes publish/subscribe events, not a writable SOME/IP method for SET."},CURRENT_GEAR:{serviceId:"0x2100",instanceId:"0x8210",modes:["get"]},PERF_VEHICLE_SPEED:{serviceId:"0x2100",instanceId:"0x8211",modes:["get"]}};function ge(s){return ue[s]||null}const Se=globalThis.React,{useEffect:V,useState:_}=Se,g=(...s)=>s.filter(Boolean).join(" "),Le=s=>{switch(s){case"STRING":return"string";case"BOOLEAN":return"boolean";case"INT32":return"int32";case"INT32_VEC":return"int32[]";case"INT64":return"int64";case"INT64_VEC":return"int64[]";case"FLOAT":return"float";case"FLOAT_VEC":return"float[]";case"BYTES":return"uint8[]";case"MIXED":default:return"string"}},Ce=s=>s.access.includes("READ_WRITE")||s.access.includes("WRITE")?"actuator":"sensor",De=s=>`Aaos.${s.area}.${s.name}`,b=({text:s,ariaLabel:t})=>{const[i,n]=_(!1);V(()=>{if(!i)return;const l=setTimeout(()=>n(!1),1500);return()=>clearTimeout(l)},[i]);const r=async()=>{var l;try{if((l=navigator==null?void 0:navigator.clipboard)!=null&&l.writeText)await navigator.clipboard.writeText(s);else{const E=document.createElement("textarea");E.value=s,document.body.appendChild(E),E.select(),document.execCommand("copy"),document.body.removeChild(E)}n(!0)}catch(E){}};return a.jsx("button",{type:"button",className:g("aaos-copy-btn",i&&"is-done"),onClick:r,"aria-label":t||"Copy",title:i?"Copied!":"Copy",children:i?a.jsx(pe,{}):a.jsx(Te,{})})},Y="aaos:someip:value",ve=({signal:s,api:t,modelId:i})=>{var X;const[n,r]=_({kind:"idle"}),[l,E]=_("get"),[p,S]=_(""),[L,N]=_(""),[y,o]=_(void 0),[c,h]=_(""),A=n,R=l,T=ge(s.name);V(()=>{var d,u;r({kind:"idle"}),E("get"),S((d=T==null?void 0:T.serviceId)!=null?d:""),N((u=T==null?void 0:T.instanceId)!=null?u:""),o(void 0),h("")},[s.name]),V(()=>{const d=u=>{const H=u,O=H==null?void 0:H.detail;!(O!=null&&O.signalName)||O.signalName!==s.name||(o(O.value===void 0?null:O.value),h(O.timestamp||new Date().toISOString()))};return window.addEventListener(Y,d),()=>{window.removeEventListener(Y,d)}},[s.name]);const z=oe(s),q=ce(s),f=De(s),x=me(s.name),I=(X=T==null?void 0:T.operations)==null?void 0:X[R],C=typeof(t==null?void 0:t.createWishlistApi)=="function"&&!!i,Me=async()=>{if(C)try{r({kind:"loading"}),await t.createWishlistApi({model:i,apiName:f,description:s.description,type:Ce(s),datatype:Le(s.dataType),skeleton:f,isWishlist:!0,...s.unit?{unit:s.unit}:{}}),r({kind:"success",message:`Added "${f}" as a wishlist signal.`})}catch(d){const u=(d==null?void 0:d.message)||"Failed to add as wishlist signal. See host toast.";r({kind:"error",message:u})}},G=[{key:"Signal",value:s.name},{key:"Group (Name)",value:s.group},{key:"Full Path",value:q},{key:"Property ID",value:z},{key:"Description",value:s.description},{key:"Change Mode",value:s.changeMode},{key:"Access",value:s.access.join(", ")},{key:"Vehicle Area",value:s.area},{key:"Data Type",value:s.dataType},{key:"VHAL Version",value:String(s.version)}];return s.unit&&G.push({key:"Unit",value:s.unit}),s.dataEnum&&s.dataEnum.length>0&&G.push({key:"Data Enum",value:s.dataEnum.join(", ")}),s.dataEnumBitFlags&&G.push({key:"Bit Flags",value:"data_enum_bit_flags"}),a.jsxs("div",{className:"aaos-detail",children:[a.jsxs("div",{className:"aaos-detail-bar",children:[a.jsxs("div",{className:"aaos-detail-name",children:[a.jsx("span",{children:s.name}),a.jsx(b,{text:s.name,ariaLabel:"Copy signal name"})]}),a.jsx("div",{className:"aaos-area-pill",children:s.area})]}),a.jsxs("div",{className:"aaos-detail-body",children:[a.jsx("div",{className:"aaos-section-title",children:"AAOS VehicleProperty"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsx("tbody",{children:G.map(d=>a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:d.key}),a.jsx("td",{className:"v",children:d.value})]},d.key))})}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"COVESA matching signals"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Exact matches"}),a.jsx("td",{className:"v",children:x.exact.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:x.exact.map(d=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:d}),a.jsx(b,{text:d,ariaLabel:"Copy exact COVESA match"})]},`exact-${d}`))})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Partial matches"}),a.jsx("td",{className:"v",children:x.partial.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:x.partial.map(d=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:d}),a.jsx(b,{text:d,ariaLabel:"Copy partial COVESA match"})]},`partial-${d}`))})})]})]})}),T&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"aaos-section-title has-spacing",children:"SOME/IP Mapping"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Service ID"}),a.jsx("td",{className:"v",children:a.jsx("input",{className:"aaos-edit-field",value:p,onChange:d=>S(d.target.value),spellCheck:!1})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Instance ID"}),a.jsx("td",{className:"v",children:a.jsx("input",{className:"aaos-edit-field",value:L,onChange:d=>N(d.target.value),spellCheck:!1})})]}),I&&a.jsxs("tr",{children:[a.jsxs("td",{className:"k",children:[I.kind.charAt(0).toUpperCase()+I.kind.slice(1)," ","ID"]}),a.jsx("td",{className:"v",children:I.id})]}),(I==null?void 0:I.eventGroupId)&&a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Event Group ID"}),a.jsx("td",{className:"v",children:I.eventGroupId})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Received Value"}),a.jsx("td",{className:"v",children:y===void 0?a.jsx("span",{className:"aaos-value-placeholder",children:"Waiting for communication value..."}):a.jsxs("div",{className:"aaos-received-value-wrap",children:[a.jsx("span",{className:"aaos-value-chip",children:String(y)}),c&&a.jsxs("span",{className:"aaos-value-meta",children:["Updated: ",c]})]})})]})]})}),a.jsxs("div",{className:"aaos-someip-actions",style:{marginTop:10},children:[a.jsx("button",{type:"button",disabled:!T.modes.includes("get"),className:g("aaos-segment-btn",R==="get"&&T.modes.includes("get")&&"is-active",!T.modes.includes("get")&&"is-disabled"),onClick:()=>T.modes.includes("get")&&E("get"),children:"Get"}),a.jsx("button",{type:"button",disabled:!T.modes.includes("set"),className:g("aaos-segment-btn",R==="set"&&T.modes.includes("set")&&"is-active",!T.modes.includes("set")&&"is-disabled"),onClick:()=>T.modes.includes("set")&&E("set"),children:"Set"})]})]}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"Property ID Composition"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Base ID"}),a.jsx("td",{className:"v",children:s.baseId})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Group"}),a.jsx("td",{className:"v",children:"SYSTEM (0x10000000)"})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Vehicle Area"}),a.jsx("td",{className:"v",children:s.area})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Data Type"}),a.jsx("td",{className:"v",children:s.dataType})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Computed ID"}),a.jsx("td",{className:"v",children:z})]})]})}),a.jsxs("div",{className:"aaos-actions",children:[a.jsxs("button",{type:"button",className:g("aaos-btn",!C&&"is-secondary"),onClick:Me,disabled:!C||A.kind==="loading",title:C?`Register ${f} as a wishlist signal on this model`:"Wishlist API is unavailable in this context",children:[a.jsx(he,{}),A.kind==="loading"?"Adding…":"Add as wishlist signal"]}),a.jsx(b,{text:q,ariaLabel:"Copy full path"})]}),a.jsxs("div",{className:g("aaos-status",A.kind==="error"&&"is-error",A.kind==="success"&&"is-success",A.kind!=="error"&&A.kind!=="success"&&"is-info"),children:[A.kind==="success"&&A.message,A.kind==="error"&&A.message,A.kind==="idle"&&!C&&a.jsx("span",{children:t!=null&&t.createWishlistApi?"No model in context — wishlist signals require a model.":"Wishlist API not provided by host."})]})]})]})},be=globalThis.React,{useState:ye}=be,fe=({data:s,api:t})=>{var E;const[i,n]=ye(null),r=new Set(M.map(p=>p.group)).size,l=(E=s==null?void 0:s.model)==null?void 0:E.id;return a.jsxs("div",{className:"aaos-root",children:[a.jsxs("div",{className:"aaos-header",children:[a.jsxs("div",{className:"aaos-header-title",children:[a.jsx(P,{}),a.jsx("span",{children:"AAOS Vehicle Properties"})]}),a.jsx("div",{className:"aaos-header-right",children:a.jsxs("div",{className:"aaos-header-counter",children:[M.length," signals · ",r," groups"]})})]}),a.jsxs("div",{className:"aaos-body",children:[a.jsx(_e,{signals:M,selectedSignal:i,onSelectSignal:n}),a.jsx("div",{className:"aaos-right",children:i?a.jsx(ve,{signal:i,api:t,modelId:l}):a.jsxs("div",{className:"aaos-placeholder",children:[a.jsx("div",{className:"aaos-placeholder-icon",children:a.jsx(P,{size:56})}),a.jsx("div",{className:"aaos-placeholder-title",children:"Select an AAOS signal to view its details"}),a.jsx("div",{className:"aaos-placeholder-sub",children:"Pick a signal from the list on the left"})]})})]})]})},K="aaos-plugin-styles",xe=`
.aaos-root {
  --aaos-bg: #ffffff;
  --aaos-fg: #0f172a;
  --aaos-muted: #64748b;
...
`,Ge=()=>{if(typeof document=="undefined"||document.getElementById(K))return;const s=document.createElement("style");s.id=K,s.appendChild(document.createTextNode(xe)),document.head.appendChild(s)};window.DAPlugins||(window.DAPlugins={}),window.DAPlugins["page-plugin"]={components:{Page:fe},unmount:s=>{s&&(s.innerHTML="")}},Ge()})(React);
