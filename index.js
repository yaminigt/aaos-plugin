(function(se){"use strict";var F={exports:{}},b={};/**
 * @license React
...
`.trim(),Le=s=>{const t=s.trim();return t===""||t==="—"||t==="-"||t.toLowerCase()==="n/a"},q=s=>{if(Le(s))return[];const t=s.split(",").map(r=>r.trim()).flatMap(r=>r.includes(" / ")&&r.includes("Vehicle.")?r.split(" / ").map(l=>l.trim()):[r]).map(r=>r.trim()).filter(r=>r.length>0&&r!=="—"&&r!=="-"),i=new Set,n=[];for(const r of t)i.has(r)||(i.add(r),n.push(r));return n},Ce=()=>{const s={};for(const t of Se.split(`
`)){const i=t.trim();if(!i)continue;const n=i.split("|").map(T=>T.trim()),r=n[0],l=q(n[1]||""),A=q(n[2]||"");r&&(s[r]={exact:l,partial:A})}return s};let H=null;const De=s=>(H||(H=Ce()),H[s]||{exact:[],partial:[]}),ve={TIRE_PRESSURE:{serviceId:"0x4100",instanceId:"0x1000",operations:{get:{id:"0x8410",kind:"event",eventGroupId:"0x9410",transport:"reliable",port:"4100",updateCycleMs:3e3}},modes:["get"],notes:"Derived from vsomeip/vsomeip/tire_pressure_sample.json. This config exposes publish/subscribe events, not a writable SOME/IP method for SET."},CURRENT_GEAR:{serviceId:"0x2100",instanceId:"0x8210",modes:["get"]},PERF_VEHICLE_SPEED:{serviceId:"0x2100",instanceId:"0x8211",modes:["get"]}};function be(s){return ve[s]||null}const ye=globalThis.React,{useEffect:W,useState:N}=ye,C=(...s)=>s.filter(Boolean).join(" "),fe=s=>{switch(s){case"STRING":return"string";case"BOOLEAN":return"boolean";case"INT32":return"int32";case"INT32_VEC":return"int32[]";case"INT64":return"int64";case"INT64_VEC":return"int64[]";case"FLOAT":return"float";case"FLOAT_VEC":return"float[]";case"BYTES":return"uint8[]";case"MIXED":default:return"string"}},xe=s=>s.access.includes("READ_WRITE")||s.access.includes("WRITE")?"actuator":"sensor",Ge=s=>`Aaos.${s.area}.${s.name}`,f=({text:s,ariaLabel:t})=>{const[i,n]=N(!1);W(()=>{if(!i)return;const l=setTimeout(()=>n(!1),1500);return()=>clearTimeout(l)},[i]);const r=async()=>{var l;try{if((l=navigator==null?void 0:navigator.clipboard)!=null&&l.writeText)await navigator.clipboard.writeText(s);else{const A=document.createElement("textarea");A.value=s,document.body.appendChild(A),A.select(),document.execCommand("copy"),document.body.removeChild(A)}n(!0)}catch(A){}};return a.jsx("button",{type:"button",className:C("aaos-copy-btn",i&&"is-done"),onClick:r,"aria-label":t||"Copy",title:i?"Copied!":"Copy",children:i?a.jsx(Oe,{}):a.jsx(Re,{})})},Me="aaos:someip:request",X="aaos:someip:tire-pressure:value",Ve=({signal:s,api:t,modelId:i})=>{var ae;const[n,r]=N({kind:"idle"}),[l,A]=N("get"),[T,D]=N(""),[g,m]=N(""),[w,c]=N(void 0),[d,h]=N(void 0),[I,S]=N(""),[P,x]=N(!1),_=n,U=l,Z=w,Q=d,E=be(s.name);W(()=>{var o,R;r({kind:"idle"}),A("get"),D((o=E==null?void 0:E.serviceId)!=null?o:""),m((R=E==null?void 0:E.instanceId)!=null?R:""),c(void 0),h(void 0),S(""),x(!1)},[s.name]),W(()=>{const o=R=>{const L=R,p=L==null?void 0:L.detail;!(p!=null&&p.signalName)||p.signalName!==s.name||(c(p.frontValue===void 0?null:p.frontValue),h(p.rearValue===void 0?null:p.rearValue),S(p.timestamp||new Date().toISOString()),x(!1))};return window.addEventListener(X,o),()=>{window.removeEventListener(X,o)}},[s.name]);const J=Te(s),ee=pe(s),G=Ge(s),M=De(s.name),O=(ae=E==null?void 0:E.operations)==null?void 0:ae[U],v=typeof(t==null?void 0:t.createWishlistApi)=="function"&&!!i,Ue=async()=>{var L;if(!E||!E.modes.includes("get"))return;const o=(L=E.operations)==null?void 0:L.get,R={signalName:s.name,mode:"get",someip:{serviceId:T||E.serviceId,instanceId:g||E.instanceId,operationId:o==null?void 0:o.id,eventGroupId:o==null?void 0:o.eventGroupId},requestedAt:new Date().toISOString()};A("get"),x(!0);try{typeof(t==null?void 0:t.sendSomeipPacket)=="function"&&await t.sendSomeipPacket(R)}catch(p){x(!1);const je=(p==null?void 0:p.message)||"Failed to send SOME/IP GET request package.";r({kind:"error",message:je})}window.dispatchEvent(new CustomEvent(Me,{detail:R}))},Fe=s.name==="TIRE_PRESSURE",ke=async()=>{if(v)try{r({kind:"loading"}),await t.createWishlistApi({model:i,apiName:G,description:s.description,type:xe(s),datatype:fe(s.dataType),skeleton:G,isWishlist:!0,...s.unit?{unit:s.unit}:{}}),r({kind:"success",message:`Added "${G}" as a wishlist signal.`})}catch(o){const R=(o==null?void 0:o.message)||"Failed to add as wishlist signal. See host toast.";r({kind:"error",message:R})}},V=[{key:"Signal",value:s.name},{key:"Group (Name)",value:s.group},{key:"Full Path",value:ee},{key:"Property ID",value:J},{key:"Description",value:s.description},{key:"Change Mode",value:s.changeMode},{key:"Access",value:s.access.join(", ")},{key:"Vehicle Area",value:s.area},{key:"Data Type",value:s.dataType},{key:"VHAL Version",value:String(s.version)}];return s.unit&&V.push({key:"Unit",value:s.unit}),s.dataEnum&&s.dataEnum.length>0&&V.push({key:"Data Enum",value:s.dataEnum.join(", ")}),s.dataEnumBitFlags&&V.push({key:"Bit Flags",value:"data_enum_bit_flags"}),a.jsxs("div",{className:"aaos-detail",children:[a.jsxs("div",{className:"aaos-detail-bar",children:[a.jsxs("div",{className:"aaos-detail-name",children:[a.jsx("span",{children:s.name}),a.jsx(f,{text:s.name,ariaLabel:"Copy signal name"})]}),a.jsx("div",{className:"aaos-area-pill",children:s.area})]}),a.jsxs("div",{className:"aaos-detail-body",children:[a.jsx("div",{className:"aaos-section-title",children:"AAOS VehicleProperty"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsx("tbody",{children:V.map(o=>a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:o.key}),a.jsx("td",{className:"v",children:o.value})]},o.key))})}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"COVESA matching signals"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Exact matches"}),a.jsx("td",{className:"v",children:M.exact.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:M.exact.map(o=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:o}),a.jsx(f,{text:o,ariaLabel:"Copy exact COVESA match"})]},`exact-${o}`))})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Partial matches"}),a.jsx("td",{className:"v",children:M.partial.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:M.partial.map(o=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:o}),a.jsx(f,{text:o,ariaLabel:"Copy partial COVESA match"})]},`partial-${o}`))})})]})]})}),E&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"aaos-section-title has-spacing",children:"SOME/IP Mapping"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Service ID"}),a.jsx("td",{className:"v",children:a.jsx("input",{className:"aaos-edit-field",value:T,onChange:o=>D(o.target.value),spellCheck:!1})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Instance ID"}),a.jsx("td",{className:"v",children:a.jsx("input",{className:"aaos-edit-field",value:g,onChange:o=>m(o.target.value),spellCheck:!1})})]}),O&&a.jsxs("tr",{children:[a.jsxs("td",{className:"k",children:[O.kind.charAt(0).toUpperCase()+O.kind.slice(1)," ","ID"]}),a.jsx("td",{className:"v",children:O.id})]}),(O==null?void 0:O.eventGroupId)&&a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Event Group ID"}),a.jsx("td",{className:"v",children:O.eventGroupId})]}),Fe?a.jsxs(a.Fragment,{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Tire Pressure Front Value"}),a.jsx("td",{className:"v",children:Z===void 0?a.jsx("span",{className:"aaos-value-placeholder",children:P?"Waiting for front tire value from image...":"Press Get to request front tire value"}):a.jsx("span",{className:"aaos-value-chip",children:String(Z)})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Tire Pressure Rear Value"}),a.jsx("td",{className:"v",children:Q===void 0?a.jsx("span",{className:"aaos-value-placeholder",children:P?"Waiting for rear tire value from image...":"Press Get to request rear tire value"}):a.jsx("span",{className:"aaos-value-chip",children:String(Q)})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Last Response Time"}),a.jsx("td",{className:"v",children:I?a.jsx("span",{className:"aaos-value-meta",children:I}):a.jsx("span",{className:"aaos-value-placeholder",children:"No response yet"})})]})]}):a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Received Value"}),a.jsx("td",{className:"v",children:a.jsx("span",{className:"aaos-value-placeholder",children:"Signal-specific display is available for TIRE_PRESSURE."})})]})]})}),a.jsxs("div",{className:"aaos-someip-actions",style:{marginTop:10},children:[a.jsx("button",{type:"button",disabled:!E.modes.includes("get"),className:C("aaos-segment-btn",U==="get"&&E.modes.includes("get")&&"is-active",!E.modes.includes("get")&&"is-disabled"),onClick:Ue,children:P?"Getting...":"Get"}),a.jsx("button",{type:"button",disabled:!E.modes.includes("set"),className:C("aaos-segment-btn",U==="set"&&E.modes.includes("set")&&"is-active",!E.modes.includes("set")&&"is-disabled"),onClick:()=>E.modes.includes("set")&&A("set"),children:"Set"})]})]}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"Property ID Composition"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Base ID"}),a.jsx("td",{className:"v",children:s.baseId})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Group"}),a.jsx("td",{className:"v",children:"SYSTEM (0x10000000)"})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Vehicle Area"}),a.jsx("td",{className:"v",children:s.area})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Data Type"}),a.jsx("td",{className:"v",children:s.dataType})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Computed ID"}),a.jsx("td",{className:"v",children:J})]})]})}),a.jsxs("div",{className:"aaos-actions",children:[a.jsxs("button",{type:"button",className:C("aaos-btn",!v&&"is-secondary"),onClick:ke,disabled:!v||_.kind==="loading",title:v?`Register ${G} as a wishlist signal on this model`:"Wishlist API is unavailable in this context",children:[a.jsx(me,{}),_.kind==="loading"?"Adding…":"Add as wishlist signal"]}),a.jsx(f,{text:ee,ariaLabel:"Copy full path"})]}),a.jsxs("div",{className:C("aaos-status",_.kind==="error"&&"is-error",_.kind==="success"&&"is-success",_.kind!=="error"&&_.kind!=="success"&&"is-info"),children:[_.kind==="success"&&_.message,_.kind==="error"&&_.message,_.kind==="idle"&&!v&&a.jsx("span",{children:t!=null&&t.createWishlistApi?"No model in context — wishlist signals require a model.":"Wishlist API not provided by host."})]})]})]})},Be=globalThis.React,{useState:He}=Be,We=({data:s,api:t})=>{var A;const[i,n]=He(null),r=new Set(B.map(T=>T.group)).size,l=(A=s==null?void 0:s.model)==null?void 0:A.id;return a.jsxs("div",{className:"aaos-root",children:[a.jsxs("div",{className:"aaos-header",children:[a.jsxs("div",{className:"aaos-header-title",children:[a.jsx(j,{}),a.jsx("span",{children:"AAOS Vehicle Properties"})]}),a.jsx("div",{className:"aaos-header-right",children:a.jsxs("div",{className:"aaos-header-counter",children:[B.length," signals · ",r," groups"]})})]}),a.jsxs("div",{className:"aaos-body",children:[a.jsx(ge,{signals:B,selectedSignal:i,onSelectSignal:n}),a.jsx("div",{className:"aaos-right",children:i?a.jsx(Ve,{signal:i,api:t,modelId:l}):a.jsxs("div",{className:"aaos-placeholder",children:[a.jsx("div",{className:"aaos-placeholder-icon",children:a.jsx(j,{size:56})}),a.jsx("div",{className:"aaos-placeholder-title",children:"Select an AAOS signal to view its details"}),a.jsx("div",{className:"aaos-placeholder-sub",children:"Pick a signal from the list on the left"})]})})]})]})},$="aaos-plugin-styles",we=`
.aaos-root {
  --aaos-bg: #ffffff;
  --aaos-fg: #0f172a;
  --aaos-muted: #64748b;
...
`,Pe=()=>{if(typeof document=="undefined"||document.getElementById($))return;const s=document.createElement("style");s.id=$,s.appendChild(document.createTextNode(we)),document.head.appendChild(s)};window.DAPlugins||(window.DAPlugins={}),window.DAPlugins["page-plugin"]={components:{Page:We},unmount:s=>{s&&(s.innerHTML="")}},Pe()})(React);
