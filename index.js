(function(ie){"use strict";var j={exports:{}},x={};/**
 * @license React
...
`.trim(),ve=s=>{const t=s.trim();return t===""||t==="—"||t==="-"||t.toLowerCase()==="n/a"},$=s=>{if(ve(s))return[];const t=s.split(",").map(c=>c.trim()).flatMap(c=>c.includes(" / ")&&c.includes("Vehicle.")?c.split(" / ").map(l=>l.trim()):[c]).map(c=>c.trim()).filter(c=>c.length>0&&c!=="—"&&c!=="-"),r=new Set,o=[];for(const c of t)r.has(c)||(r.add(c),o.push(c));return o},ye=()=>{const s={};for(const t of De.split(`
`)){const r=t.trim();if(!r)continue;const o=r.split("|").map(p=>p.trim()),c=o[0],l=$(o[1]||""),A=$(o[2]||"");c&&(s[c]={exact:l,partial:A})}return s};let w=null;const be=s=>(w||(w=ye()),w[s]||{exact:[],partial:[]}),fe={TIRE_PRESSURE:{serviceId:"0x4100",instanceId:"0x1000",operations:{get:{id:"0x8410",kind:"event",eventGroupId:"0x9410",transport:"reliable",port:"4100",updateCycleMs:3e3}},modes:["get"],notes:"Derived from vsomeip/vsomeip/tire_pressure_sample.json. This config exposes publish/subscribe events, not a writable SOME/IP method for SET."},CURRENT_GEAR:{serviceId:"0x2100",instanceId:"0x8210",modes:["get"]},PERF_VEHICLE_SPEED:{serviceId:"0x2100",instanceId:"0x8211",modes:["get"]}};function xe(s){return fe[s]||null}const Ge=globalThis.React,{useEffect:P,useState:m}=Ge,v=(...s)=>s.filter(Boolean).join(" "),Me=s=>{switch(s){case"STRING":return"string";case"BOOLEAN":return"boolean";case"INT32":return"int32";case"INT32_VEC":return"int32[]";case"INT64":return"int64";case"INT64_VEC":return"int64[]";case"FLOAT":return"float";case"FLOAT_VEC":return"float[]";case"BYTES":return"uint8[]";case"MIXED":default:return"string"}},Ve=s=>s.access.includes("READ_WRITE")||s.access.includes("WRITE")?"actuator":"sensor",Be=s=>`Aaos.${s.area}.${s.name}`,M=({text:s,ariaLabel:t})=>{const[r,o]=m(!1);P(()=>{if(!r)return;const l=setTimeout(()=>o(!1),1500);return()=>clearTimeout(l)},[r]);const c=async()=>{var l;try{if((l=navigator==null?void 0:navigator.clipboard)!=null&&l.writeText)await navigator.clipboard.writeText(s);else{const A=document.createElement("textarea");A.value=s,document.body.appendChild(A),A.select(),document.execCommand("copy"),document.body.removeChild(A)}o(!0)}catch(A){}};return a.jsx("button",{type:"button",className:v("aaos-copy-btn",r&&"is-done"),onClick:c,"aria-label":t||"Copy",title:r?"Copied!":"Copy",children:r?a.jsx(ge,{}):a.jsx(ue,{})})},Z="aaos:someip:request",Q="aaos:someip:value",He=s=>{const t=s.includes("READ")||s.includes("READ_WRITE"),r=s.includes("WRITE")||s.includes("READ_WRITE"),o=[];return t&&o.push("get"),r&&o.push("set"),o},We=({signal:s,api:t,modelId:r})=>{var ne;const[o,c]=m({kind:"idle"}),[l,A]=m("get"),[p,y]=m(""),[u,g]=m(""),[U,d]=m(void 0),[E,_]=m(""),[N,C]=m(""),[ee,D]=m(!1),R=o,F=l,ae=U,i=xe(s.name),O=He(s.access);(ne=i==null?void 0:i.operations)==null||ne[F],P(()=>{var I,h;c({kind:"idle"}),A("get"),y((I=i==null?void 0:i.serviceId)!=null?I:""),g((h=i==null?void 0:i.instanceId)!=null?h:""),d(void 0),_(""),C("");const n=O.includes("get")?"get":O.includes("set")?"set":"get";A(n),D(!1)},[s.name]),P(()=>{const n=I=>{const h=I,T=h==null?void 0:h.detail;!(T!=null&&T.signalName)||T.signalName!==s.name||(d(T.value===void 0?null:T.value),C(T.timestamp||new Date().toISOString()),D(!1))};return window.addEventListener(Q,n),()=>{window.removeEventListener(Q,n)}},[s.name]);const se=he(s),te=_e(s),V=Be(s),B=be(s.name),b=typeof(t==null?void 0:t.createWishlistApi)=="function"&&!!r,je=async()=>{var h,T,f;if(!O.includes("get"))return;const n=(h=i==null?void 0:i.operations)==null?void 0:h.get,I={signalName:s.name,mode:"get",someip:{serviceId:p||(i==null?void 0:i.serviceId)||"",instanceId:u||(i==null?void 0:i.instanceId)||"",operationId:n==null?void 0:n.id,operationKind:n==null?void 0:n.kind,eventGroupId:n==null?void 0:n.eventGroupId,transport:n==null?void 0:n.transport,port:n==null?void 0:n.port,updateCycleMs:n==null?void 0:n.updateCycleMs,operations:{get:(T=i==null?void 0:i.operations)!=null&&T.get?{id:i.operations.get.id,kind:i.operations.get.kind,eventGroupId:i.operations.get.eventGroupId,transport:i.operations.get.transport,port:i.operations.get.port,updateCycleMs:i.operations.get.updateCycleMs}:void 0,set:(f=i==null?void 0:i.operations)!=null&&f.set?{id:i.operations.set.id,kind:i.operations.set.kind,eventGroupId:i.operations.set.eventGroupId,transport:i.operations.set.transport,port:i.operations.set.port,updateCycleMs:i.operations.set.updateCycleMs}:void 0}},requestedAt:new Date().toISOString()};A("get"),D(!0);try{typeof(t==null?void 0:t.sendSomeipPacket)=="function"&&await t.sendSomeipPacket(I)}catch(S){D(!1);const k=(S==null?void 0:S.message)||"Failed to send SOME/IP GET request package.";c({kind:"error",message:k})}window.dispatchEvent(new CustomEvent(Z,{detail:I}))},Ye=async()=>{var h,T,f;if(!O.includes("set"))return;const n=(h=i==null?void 0:i.operations)==null?void 0:h.set,I={signalName:s.name,mode:"set",value:E,someip:{serviceId:p||(i==null?void 0:i.serviceId)||"",instanceId:u||(i==null?void 0:i.instanceId)||"",operationId:n==null?void 0:n.id,operationKind:n==null?void 0:n.kind,eventGroupId:n==null?void 0:n.eventGroupId,transport:n==null?void 0:n.transport,port:n==null?void 0:n.port,updateCycleMs:n==null?void 0:n.updateCycleMs,operations:{get:(T=i==null?void 0:i.operations)!=null&&T.get?{id:i.operations.get.id,kind:i.operations.get.kind,eventGroupId:i.operations.get.eventGroupId,transport:i.operations.get.transport,port:i.operations.get.port,updateCycleMs:i.operations.get.updateCycleMs}:void 0,set:(f=i==null?void 0:i.operations)!=null&&f.set?{id:i.operations.set.id,kind:i.operations.set.kind,eventGroupId:i.operations.set.eventGroupId,transport:i.operations.set.transport,port:i.operations.set.port,updateCycleMs:i.operations.set.updateCycleMs}:void 0}},requestedAt:new Date().toISOString()};A("set"),D(!0);try{typeof(t==null?void 0:t.sendSomeipPacket)=="function"&&await t.sendSomeipPacket(I)}catch(S){D(!1);const k=(S==null?void 0:S.message)||"Failed to send SOME/IP SET request package.";c({kind:"error",message:k})}window.dispatchEvent(new CustomEvent(Z,{detail:I}))},Ke=async()=>{if(b)try{c({kind:"loading"}),await t.createWishlistApi({model:r,apiName:V,description:s.description,type:Ve(s),datatype:Me(s.dataType),skeleton:V,isWishlist:!0,...s.unit?{unit:s.unit}:{}}),c({kind:"success",message:`Added "${V}" as a wishlist signal.`})}catch(n){const I=(n==null?void 0:n.message)||"Failed to add as wishlist signal. See host toast.";c({kind:"error",message:I})}},H=[{key:"Signal",value:s.name},{key:"Group (Name)",value:s.group},{key:"Full Path",value:te},{key:"Property ID",value:se},{key:"Description",value:s.description},{key:"Change Mode",value:s.changeMode},{key:"Access",value:s.access.join(", ")},{key:"Vehicle Area",value:s.area},{key:"Data Type",value:s.dataType},{key:"VHAL Version",value:String(s.version)}];return s.unit&&H.push({key:"Unit",value:s.unit}),s.dataEnum&&s.dataEnum.length>0&&H.push({key:"Data Enum",value:s.dataEnum.join(", ")}),s.dataEnumBitFlags&&H.push({key:"Bit Flags",value:"data_enum_bit_flags"}),a.jsxs("div",{className:"aaos-detail",children:[a.jsxs("div",{className:"aaos-detail-bar",children:[a.jsxs("div",{className:"aaos-detail-name",children:[a.jsx("span",{children:s.name}),a.jsx(M,{text:s.name,ariaLabel:"Copy signal name"})]}),a.jsx("div",{className:"aaos-area-pill",children:s.area})]}),a.jsxs("div",{className:"aaos-detail-body",children:[a.jsx("div",{className:"aaos-section-title",children:"AAOS VehicleProperty"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsx("tbody",{children:H.map(n=>a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:n.key}),a.jsx("td",{className:"v",children:n.value})]},n.key))})}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"COVESA matching signals"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Exact matches"}),a.jsx("td",{className:"v",children:B.exact.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:B.exact.map(n=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:n}),a.jsx(M,{text:n,ariaLabel:"Copy exact COVESA match"})]},`exact-${n}`))})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Partial matches"}),a.jsx("td",{className:"v",children:B.partial.length===0?a.jsx("span",{children:"—"}):a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:6},children:B.partial.map(n=>a.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8},children:[a.jsx("span",{children:n}),a.jsx(M,{text:n,ariaLabel:"Copy partial COVESA match"})]},`partial-${n}`))})})]})]})}),a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"aaos-section-title has-spacing",children:"SOME/IP Mapping"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Service ID"}),a.jsx("td",{className:"v",children:a.jsx("input",{className:"aaos-edit-field",value:p,onChange:n=>y(n.target.value),placeholder:"Enter Service ID",spellCheck:!1})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Instance ID"}),a.jsx("td",{className:"v",children:a.jsx("input",{className:"aaos-edit-field",value:u,onChange:n=>g(n.target.value),placeholder:"Enter Instance ID",spellCheck:!1})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Value"}),a.jsx("td",{className:"v",children:ae===void 0?a.jsx("span",{className:"aaos-value-placeholder",children:ee?"Waiting for value from image...":"Press Get to request value"}):a.jsx("span",{className:"aaos-value-chip",children:String(ae)})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Set Value"}),a.jsx("td",{className:"v",children:a.jsx("input",{className:"aaos-edit-field",value:E,onChange:n=>_(n.target.value),placeholder:"Enter value to set",spellCheck:!1})})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Last Response Time"}),a.jsx("td",{className:"v",children:N?a.jsx("span",{className:"aaos-value-meta",children:N}):a.jsx("span",{className:"aaos-value-placeholder",children:"No response yet"})})]})]})}),a.jsxs("div",{className:"aaos-someip-actions",style:{marginTop:10},children:[a.jsx("button",{type:"button",disabled:!O.includes("get"),className:v("aaos-segment-btn",F==="get"&&O.includes("get")&&"is-active",!O.includes("get")&&"is-disabled"),onClick:je,children:ee?"Getting...":"Get"}),a.jsx("button",{type:"button",disabled:!O.includes("set"),className:v("aaos-segment-btn",F==="set"&&O.includes("set")&&"is-active",!O.includes("set")&&"is-disabled"),onClick:Ye,children:"Set"})]})]}),a.jsx("div",{className:"aaos-section-title has-spacing",children:"Property ID Composition"}),a.jsx("table",{className:"aaos-prop-table",children:a.jsxs("tbody",{children:[a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Base ID"}),a.jsx("td",{className:"v",children:s.baseId})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Group"}),a.jsx("td",{className:"v",children:"SYSTEM (0x10000000)"})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Vehicle Area"}),a.jsx("td",{className:"v",children:s.area})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Data Type"}),a.jsx("td",{className:"v",children:s.dataType})]}),a.jsxs("tr",{children:[a.jsx("td",{className:"k",children:"Computed ID"}),a.jsx("td",{className:"v",children:se})]})]})}),a.jsxs("div",{className:"aaos-actions",children:[a.jsxs("button",{type:"button",className:v("aaos-btn",!b&&"is-secondary"),onClick:Ke,disabled:!b||R.kind==="loading",title:b?`Register ${V} as a wishlist signal on this model`:"Wishlist API is unavailable in this context",children:[a.jsx(Se,{}),R.kind==="loading"?"Adding…":"Add as wishlist signal"]}),a.jsx(M,{text:te,ariaLabel:"Copy full path"})]}),a.jsxs("div",{className:v("aaos-status",R.kind==="error"&&"is-error",R.kind==="success"&&"is-success",R.kind!=="error"&&R.kind!=="success"&&"is-info"),children:[R.kind==="success"&&R.message,R.kind==="error"&&R.message,R.kind==="idle"&&!b&&a.jsx("span",{children:t!=null&&t.createWishlistApi?"No model in context — wishlist signals require a model.":"Wishlist API not provided by host."})]})]})]})},we=globalThis.React,{useState:Pe}=we,Ue=({data:s,api:t})=>{var A;const[r,o]=Pe(null),c=new Set(W.map(p=>p.group)).size,l=(A=s==null?void 0:s.model)==null?void 0:A.id;return a.jsxs("div",{className:"aaos-root",children:[a.jsxs("div",{className:"aaos-header",children:[a.jsxs("div",{className:"aaos-header-title",children:[a.jsx(K,{}),a.jsx("span",{children:"AAOS Vehicle Properties"})]}),a.jsx("div",{className:"aaos-header-right",children:a.jsxs("div",{className:"aaos-header-counter",children:[W.length," signals · ",c," groups"]})})]}),a.jsxs("div",{className:"aaos-body",children:[a.jsx(Ce,{signals:W,selectedSignal:r,onSelectSignal:o}),a.jsx("div",{className:"aaos-right",children:r?a.jsx(We,{signal:r,api:t,modelId:l}):a.jsxs("div",{className:"aaos-placeholder",children:[a.jsx("div",{className:"aaos-placeholder-icon",children:a.jsx(K,{size:56})}),a.jsx("div",{className:"aaos-placeholder-title",children:"Select an AAOS signal to view its details"}),a.jsx("div",{className:"aaos-placeholder-sub",children:"Pick a signal from the list on the left"})]})})]})]})},J="aaos-plugin-styles",Fe=`
.aaos-root {
  --aaos-bg: #ffffff;
  --aaos-fg: #0f172a;
  --aaos-muted: #64748b;
...
`,ke=()=>{if(typeof document=="undefined"||document.getElementById(J))return;const s=document.createElement("style");s.id=J,s.appendChild(document.createTextNode(Fe)),document.head.appendChild(s)};window.DAPlugins||(window.DAPlugins={}),window.DAPlugins["page-plugin"]={components:{Page:Ue},unmount:s=>{s&&(s.innerHTML="")}},ke()})(React);
